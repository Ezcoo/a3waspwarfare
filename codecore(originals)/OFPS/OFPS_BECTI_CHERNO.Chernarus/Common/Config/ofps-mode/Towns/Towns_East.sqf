...
if (CTI_TOWNS_OCCUPATION_EAST isEqualTo 2) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		EAST_SOLDIER_LAT = "CUP_O_RU_Soldier_LAT";
		...
		EAST_SOLDIER_GL = "CUP_O_RU_Soldier_GL";
		EAST_SOLDIER_MEDIC = "CUP_O_RU_Medic";
		EAST_SOLDIER_MG = "CUP_O_MVD_Soldier_MG";
		EAST_SOLDIER_PILOT = "CUP_O_RU_Pilot";
		EAST_SOLDIER_SNIPER = "CUP_O_RU_Sniper_KSVK";
		EAST_SOLDIER_MARKSMAN = "CUP_O_MVD_Soldier_Marksman";
		EAST_SOLDIER_TEAMLEADER = "CUP_O_RU_Soldier_TL";
		EAST_SOLDIER_SQUADLEADER = "CUP_O_RU_Soldier_SL";
		//--- Naval Infantry
		EAST_SOLDIER_NAVAL_INFANTRY = "O_diver_F";
		EAST_SOLDIER_NAVAL_SQUADLEADER = "O_diver_TL_F";
		//--- Light Vehicles
...
if (CTI_TOWNS_OCCUPATION_EAST isEqualTo 4) then { 
	...
	if (CTI_CUP_VEHICLES_ADDON > 0) then {
		...
		EAST_SOLDIER_AA = "CUP_O_RU_Soldier_AA";
		EAST_SOLDIER_AR = "CUP_O_RU_Soldier_AR";
		EAST_SOLDIER_AT = "CUP_O_RU_Soldier_LAT";
		EAST_SOLDIER_CREW = "CUP_O_RU_Crew";
		EAST_SOLDIER_LAT = "CUP_O_RU_Soldier_AT";
		EAST_SOLDIER_HAT = "CUP_O_RU_Soldier_HAT";
		EAST_SOLDIER_ENGINEER = "CUP_O_RU_Engineer";
		EAST_SOLDIER_EXP = "CUP_O_RU_Explosive_Specialist";
		EAST_SOLDIER_GL = "CUP_O_RUS_Soldier_GL";
		EAST_SOLDIER_MEDIC = "CUP_O_RU_Medic";
		EAST_SOLDIER_MG = "CUP_O_RU_Soldier_AR";
		EAST_SOLDIER_PILOT = "CUP_O_RU_Pilot";
		EAST_SOLDIER_SNIPER = "CUP_O_RU_Sniper_KSVK";
		EAST_SOLDIER_MARKSMAN = "CUP_O_RU_Soldier_Marksman";
		EAST_SOLDIER_TEAMLEADER = "CUP_O_RU_Soldier_TL";
		EAST_SOLDIER_SQUADLEADER = "CUP_O_RU_Soldier_SL";
		//--- Naval Infantry
		//EAST_SOLDIER_NAVAL_INFANTRY = "O_diver_F";
		...
		//--- Light Vehicles
		EAST_VEHICLE_LIGHT1 = "CUP_O_UAZ_MG_RU";
		EAST_VEHICLE_LIGHT2 = "CUP_O_BTR80_WINTER_RU";
...
//--- Statics Groups
EAST_TOWNS_STATICS_ALL = [EAST_TOWN_MG,EAST_TOWN_GL,EAST_TOWN_AT,EAST_TOWN_AA,EAST_TOWN_IGLA,EAST_TOWN_ZSU,EAST_TOWN_D30,EAST_TOWN_SPG,EAST_TOWN_DSHKM,EAST_TOWN_MG50,EAST_TOWN_AGS,EAST_TOWN_COAST];
...
//--- Infantry Squads
EAST_TOWNS_SQUAD_RIFLEMEN1 = [EAST_SOLDIER_SQUADLEADER, EAST_SOLDIER_AR, EAST_SOLDIER_MARKSMAN, EAST_SOLDIER, EAST_SOLDIER_MEDIC];
...
//Urban
EAST_TOWNS_SQUAD_RIFLEMEN1_U = [EAST_SOLDIER_SQUADLEADER_U, EAST_SOLDIER_AR_U, EAST_SOLDIER_MARKSMAN_U, EAST_SOLDIER_U, EAST_SOLDIER_MEDIC_U];
