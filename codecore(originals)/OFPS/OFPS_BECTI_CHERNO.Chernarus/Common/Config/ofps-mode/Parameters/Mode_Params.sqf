...
CTI_VEHICLES_FUEL_CONSUMPTION = 0;
...
CTI_GAMEPLAY_DARTER = 0;
CTI_TEAMSWAP = 0;
CTI_TEAMSTACK = 0;
CTI_GRAPHICS_TG_MAX = 0;
CTI_GRAPHICS_VD_MAX = 0;
CTI_WEATHER_INITIAL = 0;
CTI_WEATHER_RAIN = 0;
CTI_WEATHER_RAIN_COEF = 0;
CTI_WEATHER_SNOW = 0;
CTI_WEATHER_SNOW_COEF = 0;
CTI_WEATHER_DUST = 0;
CTI_WEATHER_DUST_COEF = 0;
CTI_WEATHER_MONSOON = 0;
CTI_WEATHER_MONSOON_COEF = 0;
