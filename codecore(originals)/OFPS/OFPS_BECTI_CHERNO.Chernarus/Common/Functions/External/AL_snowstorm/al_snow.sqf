...
[] spawn {
	...
	if (terrain_type_vanilla) then {
			...
			if (CTI_WEATHER_SNOW isEqualTo 1) then { 
				fulg_p_drop	= 0.005;
				fulg_p_particles = 15;
				fulg_p_fog_radius = 0;//zero disables fog
				fulg_p_fog_scale_multiplier = 0.5;
				fulg_p_fog_opacity_multiplier = 1;
			};
			if (CTI_WEATHER_SNOW isEqualTo 2) then { 
				fulg_p_drop	= 0.003;
				fulg_p_particles = 20;
				fulg_p_fog_radius = 150;
				fulg_p_fog_scale_multiplier = 1;
				fulg_p_fog_opacity_multiplier = 2;
			};
			...
			if (CTI_WEATHER_SNOW isEqualTo 4) then { 
				fulg_p_drop	= 0.00005;
				fulg_p_particles = 100;
				fulg_p_fog_radius = 50;
				fulg_p_fog_scale_multiplier = 1.2;
