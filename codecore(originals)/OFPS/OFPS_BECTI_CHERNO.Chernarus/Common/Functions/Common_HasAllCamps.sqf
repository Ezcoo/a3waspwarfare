...
count(_town call CTI_CO_FNC_GetTownCamps) isEqualTo count([_town, _sideID] call CTI_CO_FNC_GetTownCampsOnSide)// && _town getVariable "cti_town_sideID" isEqualTo (_sideID)