...
_town_groups = (_town getVariable ["cti_town_occupation_groups", []]) + (_town getVariable ["cti_town_resistance_groups", []]) + (_town getVariable ["cti_hc_delegated_groups_occupation", []]) + (_town getVariable ["cti_hc_delegated_groups_resistance", []]);
