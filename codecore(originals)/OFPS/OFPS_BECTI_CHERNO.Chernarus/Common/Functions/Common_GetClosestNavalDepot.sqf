/*
  # HEADER #
	Script: 		Common\Functions\Common_GetClosestNavalDepot.sqf
	Alias:			CTI_CO_FNC_GetClosestNavalDepot
	Description:	Get the closest naval depot
	Author: 		Benny
  ...
  # SYNTAX #
	[CENTER] call CTI_CO_FNC_GetClosestNavalDepot
	[CENTER, SIDE] call CTI_CO_FNC_GetClosestNavalDepot
  ...
  # EXAMPLE #
    _closest = [player, CTI_P_SideID] call CTI_CO_FNC_GetClosestNavalDepot;
*/
...
} forEach (nearestObjects [_center, CTI_TOWNS_NAVAL_DEPOT_CLASSNAME, CTI_TOWNS_NAVAL_DEPOT_RANGE]);
