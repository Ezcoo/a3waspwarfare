private ["_fog_decay_setting","_dust_variance_coef_setting","_snow_variance_coef_setting","_fog_alt_setting","_fog_decay_variance_coef_setting","_fog_forecast","_overcast_forecast","_nexttime","_rain_setting","_overcast_setting","_fog_setting","_wind_setting","_waves_setting","_rain_variance_coef_setting","_overcast_variance_coef_setting","_fog_variance_coef_setting","_fog_alt_variance_coef_setting","_wind_variance_coef_setting","_waves_variance_coef_setting","_variance_time_setting","_storm_time_setting"];
...
//_nexttime setWindDir random 360; //global - server only needed
	...
	*/
	if (CTI_WEATHER_SNOW > 0) then { 
		...
		if (CTI_WEATHER_SNOW isEqualTo 1) then { 
			null = [random 360,0,false,1200,false] execvm "Common\Functions\External\AL_snowstorm\al_snow.sqf";
		};
		if (CTI_WEATHER_SNOW isEqualTo 2) then { 
			null = [random 360,0,false,1000,false] execvm "Common\Functions\External\AL_snowstorm\al_snow.sqf";
		};
		if (CTI_WEATHER_SNOW isEqualTo 3) then { 
			null = [random 360,0,true,800,true] execvm "Common\Functions\External\AL_snowstorm\al_snow.sqf";
		};
		if (CTI_WEATHER_SNOW isEqualTo 4) then { 
			null = [random 360,0,true,600,true] execvm "Common\Functions\External\AL_snowstorm\al_snow.sqf";
		};
	};
	...
	if (CTI_WEATHER_VARIANCE_TIME isEqualTo 0) then {
		...
		while {true} do {
			...
			_nexttime setRain _rain_setting_var; //global - server only needed
			_nexttime setOvercast _overcast_setting_var; //local - needs both client/server exec
			_nexttime setFog [_fog_setting_var, _fog_decay_setting_var, _fog_alt_setting_var]; //global - server only needed
			...
			//save weather to public variable
			missionNamespace setVariable ["CTI_Weather_Settings", [_variance_time_setting,_rain_setting_var,_overcast_setting_var,[_fog_setting_var, _fog_decay_setting_var, _fog_alt_setting_var],_waves_setting_var,_wind_setting_var], true];
