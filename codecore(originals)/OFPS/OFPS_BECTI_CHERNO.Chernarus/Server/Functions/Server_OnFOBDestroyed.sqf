...
_award = 0;
_fob = false;
if (_fobtype isEqualTo "small") then {_fob = true; _award = CTI_BASE_FOB_BOUNTY;};
_large_fob = false;
if (_fobtype isEqualTo "large") then {_large_fob = true; _award = CTI_BASE_LARGE_FOB_BOUNTY;};
