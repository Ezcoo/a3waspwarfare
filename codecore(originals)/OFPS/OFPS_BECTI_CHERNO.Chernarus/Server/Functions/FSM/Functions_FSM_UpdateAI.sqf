...
CTI_FSM_UpdateAI_RespawnLeader_MP = {
	...
	[_newUnit, missionNamespace getVariable format ["CTI_AI_%1_DEFAULT_GEAR", _side]] call CTI_CO_FNC_EquipUnit;
...
CTI_FSM_UpdateAI_RespawnLeader_SP = {
	...
	[_leader, missionNamespace getVariable format ["CTI_AI_%1_DEFAULT_GEAR", _side]] call CTI_CO_FNC_EquipUnit;
