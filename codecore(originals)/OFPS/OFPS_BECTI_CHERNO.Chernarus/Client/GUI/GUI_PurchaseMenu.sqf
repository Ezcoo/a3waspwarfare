...
while { true } do {
	...
	if !([CTI_Base_BarracksInRange, CTI_Base_LightInRange, CTI_Base_HeavyInRange, CTI_Base_AirRotaryInRange, CTI_Base_AirFixedInRange, CTI_Base_RepairInRange, CTI_Base_AmmoInRange, CTI_Base_NavalInRange, CTI_Base_ExtFactoryInRange] select (uiNamespace getVariable "cti_dialog_ui_purchasemenu_factory_index")) then {
