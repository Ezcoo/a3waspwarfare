...
if (isnil "IL_Variables") then
{
	...
	//Controls whether we can load statics onto the roof of eligible vehicles
	IL_Can_Roof = true;
	
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F", "O_G_Offroad_01_F", "I_G_Offroad_01_F"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F", "O_G_Van_01_transport_F"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_covered_F","B_Truck_01_cargo_F", "B_Truck_01_flatbed_F", "B_Truck_01_transport_F", "B_T_Truck_01_covered_F", "B_T_Truck_01_transport_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG","rhsusf_M1078A1P2_B_wd_fmtv_usarmy"];
	...
	IL_Supported_Vehicles_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F","O_T_Truck_03_transport_ghex_F", "O_T_Truck_03_covered_ghex_F"];
	...
	IL_Supported_Vehicles_CHINOOK = ["CH_147F", "CH_47F", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base", "CUP_B_MI6A_CDF", "CUP_B_MI6T_CDF", "CUP_O_MI6A_RU", "CUP_O_MI6T_RU", "CUP_B_CH47F_VIV_USA", "RHS_CH_47F_10", "rhsusf_CH53E_USMC_D"]; 
	IL_Supported_Vehicles_MH9 = ["B_Heli_Light_01_F", "B_mas_mar_Heli_Light_01_F", "CUP_B_AH6J_USA", "CUP_B_AH6M_USA","CUP_B_MH6J_USA", "CUP_B_MH6J_OBS_USA", "CUP_B_MH6M_USA", "CUP_B_MH6M_OBS_USA"];
	IL_Supported_Vehicles_C130J = ["C130J_Cargo", "C130J", "CUP_B_C130J_Cargo_USMC", "CUP_O_C130J_Cargo_TKA"];
	...
	IL_Supported_Vehicles_V44 = ["B_T_VTOL_01_vehicle_F", "B_T_VTOL_01_vehicle_blue_F", "B_T_VTOL_01_vehicle_olive_F"];
	IL_Supported_Vehicles_Y32 = ["O_T_VTOL_02_vehicle_F", "O_T_VTOL_02_vehicle_dynamicLoadout_F", "O_T_VTOL_02_vehicle_hex_F", "O_T_VTOL_02_vehicle_ghex_F", "O_T_VTOL_02_vehicle_grey_F"];
	IL_Supported_Vehicles_V22 = ["CUP_B_MV22_VIV_USMC"];
	IL_Supported_Vehicles_All = IL_Supported_Vehicles_C130J + IL_Supported_Vehicles_C17 + IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_TEMPEST + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_VAN + IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_CHINOOK + IL_Supported_Vehicles_V44 + IL_Supported_Vehicles_Y32 + IL_Supported_Vehicles_V22;
    
	// Vehicles with the ability to dropping the load on the parachute
	IL_Para_Drop_Vehicles = IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_C130J + IL_Supported_Vehicles_C17 + IL_Supported_Vehicles_CHINOOK + IL_Supported_Vehicles_V44 + IL_Supported_Vehicles_Y32 + IL_Supported_Vehicles_V22;

	//Supported cargo
	IL_Supported_Stryker = ["CUP_B_M1133_MEV_Woodland", "CUP_B_M1126_ICV_MK19_Woodland", "CUP_B_M1126_ICV_M2_Woodland", "CUP_B_M1130_CV_M2_Woodland"];
	IL_Supported_HeavyStatic = ["CUP_O_ZU23_RU", "CUP_B_ZU23_CDF", "CUP_O_D30_RU", "CUP_O_D30_AT_RU", "CUP_B_M119_US"];
	IL_Supported_Static_Vanilla =["B_static_AA_F", "B_static_AT_F", "B_Static_Designator_01_F", "B_GMG_01_A_F", "B_GMG_01_high_F", "B_GMG_01_F", "B_HMG_01_A_F", "B_HMG_01_high_F", "B_HMG_01_F", "B_T_static_AA_F", "B_T_static_AT_F", "B_T_GMG_01_F", "B_T_HMG_01_F", "O_static_AA_F", "O_static_AT_F", "O_Static_Designator_02_F", "O_GMG_01_A_F", "O_GMG_01_high_F", "O_GMG_01_F", "O_HMG_01_A_F", "O_HMG_01_high_F", "O_HMG_01_F", "I_static_AA_F", "I_static_AT_F", "I_GMG_01_A_F", "I_GMG_01_high_F", "I_GMG_01_F", "I_HMG_01_A_F", "I_HMG_01_high_F", "I_HMG_01_F"];
	IL_Supported_Static_OFPS = ["ofps_B_Van_static_AA_F" , "ofps_B_Van_static_AT_F", "ofps_O_Van_static_AA_F", "ofps_O_Van_static_AT_F", "ofps_B_static_AA_F" , "ofps_B_static_AT_F", "ofps_O_static_AA_F", "ofps_O_static_AT_F"];
	IL_Supported_Static_CUP = ["CUP_B_M2StaticMG_USMC", "CUP_B_TOW_TriPod_USMC", "CUP_O_Metis_RU", "CUP_O_SPG9_ChDKZ", "CUP_O_DSHKM_ChDKZ", "CUP_O_DSHkM_MiniTriPod_ChDKZ", "CUP_O_KORD_RU","CUP_O_AGS_RU"];
	IL_Supported_Static_RHS = ["RHS_MK19_TriPod_D","RHS_M2StaticMG_MiniTripod_D","RHS_Stinger_AA_pod_D", "rhs_SPG9M_MSV", "rhs_KORD_MSV", "RHS_AGS30_TriPod_MSV", "rhs_Kornet_9M133_2_msv", "rhs_Igla_AA_pod_msv"];
	IL_Supported_Static = IL_Supported_Static_Vanilla + IL_Supported_Static_OFPS + IL_Supported_Static_CUP + IL_Supported_Static_RHS;
	IL_Supported_Static_Raised = ["B_GMG_01_high_F", "B_HMG_01_high_F", "O_GMG_01_high_F", "O_HMG_01_high_F", "I_GMG_01_high_F", "I_HMG_01_high_F", "CUP_O_DSHKM_ChDKZ", "CUP_B_M2StaticMG_USMC"];
	IL_Supported_HQ = ["O_APC_Wheeled_02_rcws_F", "B_APC_Wheeled_01_cannon_F", "O_T_APC_Wheeled_02_rcws_ghex_F", "B_T_APC_Wheeled_01_cannon_F"]; 
	IL_Supported_BRDM2 = ["CUP_O_BRDM2_CSAT", "CUP_O_BRDM2_CSAT_T", "CUP_O_BRDM2_ATGM_CSAT", "CUP_O_BRDM2_ATGM_CSAT_T"];
	IL_Supported_Vodnik = ["CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU", "CUP_O_GAZ_Vodnik_BPPU_RU"];
	IL_Supported_BTR = ["CUP_O_BTR40_MG_TKM", "CUP_O_BTR60_CSAT", "CUP_O_BTR60_Winter_RU", "CUP_O_GAZ_Vodnik_MedEvac_RU", "CUP_O_BTR90_RU"];
	IL_Supported_TT650 = ["CUP_O_TT650_CHDKZ", "CUP_O_TT650_TKA", "CUP_B_M1030_USMC"];
	IL_Supported_Cars_RU = ["CUP_O_Volha_SLA", "CUP_O_Datsun_PK"];
	IL_Supported_UAZ = ["CUP_O_UAZ_Unarmed_CSAT", "CUP_O_UAZ_AGS30_CSAT", "CUP_O_UAZ_MG_CSAT", "CUP_O_UAZ_AMB_RU", "CUP_O_UAZ_METIS_CSAT", "CUP_O_UAZ_Open_CSAT", "CUP_O_UAZ_SPG9_CSAT", "CUP_B_UAZ_Unarmed_CDF"];
	IL_Supported_HEMTT = ["B_Truck_01_cargo_F", "B_Truck_01_flatbed_F", "CUP_O_Ural_Repair_RU", "cup_b_mtvr_repair_usmc", "B_G_Van_01_fuel_F", "O_G_Van_01_fuel_F", "B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_T_Truck_01_covered_F", "B_T_Truck_01_transport_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F", "B_Truck_01_mover_F", "B_Truck_01_ammo_F", "B_T_Truck_01_ammo_F", "B_Truck_01_fuel_F", "B_T_Truck_01_fuel_F", "B_Truck_01_medical_F", "B_T_Truck_01_medical_F", "B_Truck_01_Repair_F", "B_T_Truck_01_Repair_F","rhsusf_M1078A1P2_B_wd_fmtv_usarmy"];
	IL_Supported_KAMAZ = ["CUP_O_Kamaz_RU", "CUP_O_Kamaz_Repair_RU", "CUP_O_Kamaz_Open_RU", "I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered","rhs_kamaz5350_msv"];
	IL_Supported_TEMPEST = ["O_Truck_03_transport_F", "O_T_Truck_03_transport_ghex_F", "O_Truck_03_covered_F", "O_T_Truck_03_covered_ghex_F", "O_Truck_03_repair_F", "O_T_Truck_03_repair_ghex_F", "O_Truck_03_fuel_F", "O_T_Truck_03_fuel_ghex_F", "O_Truck_03_ammo_F", "O_T_Truck_03_ammo_ghex_F", "O_Truck_03_medical_F", "O_T_Truck_03_medical_ghex_F"];
	IL_Supported_Strider = ["CUP_B_FENNEK_GER_Wdl", "CUP_B_FENNEK_GER_Des", "I_MRAP_03_F", "I_MRAP_03_gmg_F", "I_MRAP_03_hmg_F", "CAF_TAPV_ar", "caf_tapv_gl_ar", "caf_tapv_50_ar", "CAF_TAPV_tw", "caf_tapv_gl_tw", "caf_tapv_50_tw", "Night_B_MRAP_03_F", "Night_B_MRAP_03_gmg_F", "Night_B_MRAP_03_hmg_F"];
	IL_Supported_Hunter = ["CUP_B_RG31_M2_GC_USMC", "CUP_B_RG31_Mk19_OD_USMC", "CUP_RG31_M2", "CUP_B_RG31E_M2_OD_USA", "B_MRAP_01_F", "B_MRAP_01_gmg_F", "B_MRAP_01_hmg_F", "B_T_MRAP_01_F", "B_T_MRAP_01_gmg_F", "B_T_MRAP_01_hmg_F", "Marinir_B_MRAP_01_FG", "Marinir_MRAP_01_gmg_FG", "Marinir_MRAP_01_hmg_FG", "B_mas_mar_MRAP_01_med_F", "B_mas_mar_MRAP_01_F", "B_mas_mar_MRAP_01_gmg_F", "B_mas_mar_MRAP_01_hmg_F","rhs_btr80a_msv","rhsgref_BRDM2_ATGM_msv"];
	IL_Supported_Ifrit = ["O_MRAP_02_F", "O_T_MRAP_02_ghex_F", "O_MRAP_02_gmg_F", "O_T_MRAP_02_gmg_ghex_F","O_MRAP_02_hmg_F", "O_T_MRAP_02_hmg_ghex_F", "rhsusf_rg33_usmc_d", "rhsusf_rg33_usmc_wd"];
	IL_Supported_UGV = ["B_UGV_01_rcws_F","B_UGV_02_Demining_F", "O_UGV_02_Demining_F", "B_UGV_01_F", "O_UGV_01_rcws_F", "O_T_UGV_01_ghex_F", "O_T_UGV_01_rcws_ghex_F","I_UGV_01_rcws_F", "I_UGV_01_F"];
	IL_Supported_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F", "O_G_Van_01_transport_F"];
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "B_G_Offroad_01_repair_F", "O_G_Offroad_01_repair_F", "O_G_Offroad_01_armed_F", "O_G_Offroad_01_F", "JTF2_Offroad_armed_01", "B_mas_mar_Offroad_01_F", "B_mas_mar_Offroad_01_armed_F"];
	IL_Supported_SUV = ["C_SUV_01_F","RHS_UAZ_MSV_01"];
	IL_Supported_Hatchback = ["C_Hatchback_01_F", "C_Hatchback_01_sport_F"];
	IL_Supported_Hummvee_Old = ["rc_hmmwv", "HMMWV2", "HMMWV_M1035", "M1114_AGS_ACR", "HMMWV_M1151_M2", "HMMWV2_M2", "HMMWV2_MK19", "HMMWV2_TOW", "HMMWV", "HMMWV_M2", "HMMWV_MK19", "HMMWV_TOW", "CUP_B_HMMWV_Unarmed_USMC", "CUP_B_HMMWV_Ambulance_USMC", "CUP_B_HMMWV_Crows_M2_USA", "CUP_B_HMMWV_Crows_MK19_USA", "CUP_B_HMMWV_AGS_GPK_ACR", "CUP_B_HMMWV_DSHKM_GPK_ACR", "CUP_B_HMMWV_M2_GPK_USA", "CUP_B_HMMWV_M2_USMC", "CUP_B_HMMWV_M1114_USMC", "CUP_B_HMMWV_MK19_USMC", "CUP_B_HMMWV_SOV_USA", "CUP_B_HMMWV_TOW_USMC", "CUP_B_HMMWV_Transport_USA", "CUP_B_HMMWV_Terminal_USA", "CUP_C_LR_Transport_CTK", "CUP_O_Ural_RU", "CUP_O_Ural_Empty_RU", "rhsusf_m1025_d", "rhsusf_m1025_w_m2","rhsusf_m1025_w_mk19","rhsusf_m1025_d_m2"];
	IL_Supported_Hummvee_New = ["CUP_B_Jackal2_GMG_GB_D", "CUP_B_Jackal2_GMG_GB_W", "CUP_B_Jackal2_L2A1_GB_D", "CUP_B_Jackal2_L2A1_GB_W", "CUP_B_HMMWV_Unarmed_USA", "CUP_B_HMMWV_Unarmed_NATO_T", "CUP_B_HMMWV_Ambulance_USA", "CUP_B_HMMWV_Ambulance_NATO_T", "CUP_B_HMMWV_Crows_M2_NATO_T", "CUP_B_HMMWV_Crows_MK19_NATO_T", "CUP_B_HMMWV_M2_GPK_NATO_T", "CUP_B_HMMWV_M2_USA", "CUP_B_HMMWV_SOV_NATO_T", "CUP_B_HMMWV_SOV_M2_USA", "CUP_B_HMMWV_SOV_M2_NATO_T", "CUP_B_HMMWV_SOV_M2_USMC", "CUP_B_HMMWV_Transport_NATO_T", "CUP_B_HMMWV_Terminal_USMC", "CUP_B_HMMWV_Terminal_NATO_T", "CUP_B_HMMWV_TOW_USA", "CUP_B_HMMWV_TOW_NATO_T"];
	IL_Supported_HMMWV_Other = ["CUP_B_M1151_NATO_T", "CUP_B_M1152_NATO_T", "CUP_B_M1165_GMV_NATO_T", "CUP_B_M1151_Mk19_NATO_T", "CUP_B_M1151_M2_NATO_T", "CUP_B_M1151_Deploy_NATO_T", "CUP_B_M1167_NATO_T", "CUP_B_M1151_WDL_USA", "CUP_B_M1152_WDL_USA", "CUP_B_M1165_GMV_WDL_USA", "CUP_B_M1151_Mk19_WDL_USA", "CUP_B_M1151_M2_WDL_USA", "CUP_B_M1151_Deploy_WDL_USA", "CUP_B_M1167_WDL_USA", "CUP_B_M1151_USA", "CUP_B_M1152_USA", "CUP_B_M1165_GMV_USA", "CUP_B_M1151_Mk19_USA", "CUP_B_M1151_M2_USA", "CUP_B_M1151_Deploy_USA", "CUP_B_M1167_USA", "CUP_B_M1151_USMC", "CUP_B_M1152_USMC", "CUP_B_M1165_GMV_USMC", "CUP_B_M1151_Mk19_USMC", "CUP_B_M1151_M2_USMC", "CUP_B_M1151_Deploy_USMC", "CUP_B_M1167_USMC","CUP_B_M1151_DSRT_USMC", "CUP_B_M1152_DSRT_USMC", "CUP_B_M1165_GMV_DSRT_USMC", "CUP_B_M1151_Mk19_DSRT_USMC", "CUP_B_M1151_M2_DSRT_USMC", "CUP_B_M1151_Deploy_DSRT_USMC", "CUP_B_M1167_DSRT_USMC"];
	IL_Supported_Hummvee = IL_Supported_Hummvee_Old + IL_Supported_Hummvee_New + IL_Supported_HMMWV_Other;
	...
	IL_Supported_Vehicles_NYX = ["I_LT_01_AT_F", "I_LT_01_scout_F", "I_LT_01_cannon_F", "I_LT_01_AA_F", "OFPS_AWC_AT_B", "OFPS_AWC_SCOUT_B", "OFPS_AWC_CANNON_B", "OFPS_AWC_AA_B", "OFPS_AWC_AT_O", "OFPS_AWC_SCOUT_O", "OFPS_AWC_CANNON_O", "OFPS_AWC_AA_O"];
	...
	IL_Supported_Cargo_Veh_Offroad = IL_Supported_Quadbike + IL_Supported_TT650 + IL_Supported_HeavyStatic + IL_Supported_Static;
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_TT650 + IL_Supported_Cars_RU + IL_Supported_UAZ + IL_Supported_HeavyStatic + IL_Supported_Static;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_TT650;
	...
	IL_Supported_Cargo_Veh_C130J = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Hummvee + IL_Supported_HEMTT + IL_Supported_LAV + IL_Supported_TEMPEST + IL_Supported_BRDM2 + IL_Supported_Vodnik + IL_Supported_BTR + IL_Supported_HQ + IL_Supported_KAMAZ + IL_Supported_Stryker + IL_Supported_Vehicles_NYX;
	...
	IL_Supported_Cargo_Veh_V44 = IL_Supported_Cargo_Veh_C17;
	IL_Supported_Cargo_NonVeh_V44 = IL_Supported_Cargo_NonVeh_C17;
	IL_Supported_Cargo_V44 = IL_Supported_Cargo_Veh_V44 + IL_Supported_Cargo_NonVeh_V44;
	
	IL_Supported_Cargo_Veh_Y32 = IL_Supported_Cargo_Veh_HEMTT + IL_Supported_Strider + IL_Supported_Hunter + IL_Supported_Ifrit + IL_Supported_Hummvee + IL_Supported_LAV + IL_Supported_BRDM2 + IL_Supported_Vodnik + IL_Supported_BTR + IL_Supported_HQ + IL_Supported_Stryker + IL_Supported_KAMAZ; 
	IL_Supported_Cargo_NonVeh_Y32 = IL_Supported_Cargo_NonVeh_C17;
	IL_Supported_Cargo_Y32 = IL_Supported_Cargo_Veh_Y32 + IL_Supported_Cargo_NonVeh_Y32;
	
	IL_Supported_Cargo_Veh_V22 = IL_Supported_Cargo_Veh_Y32;
	IL_Supported_Cargo_NonVeh_V22 = IL_Supported_Cargo_NonVeh_Y32;
	IL_Supported_Cargo_V22 = IL_Supported_Cargo_Veh_V22 + IL_Supported_Cargo_NonVeh_V22;
};
//	END VARIABLES
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_C130J) then
		{
			...
			if ((_obj_type isEqualTo "C130J_Cargo") || (_obj_type isEqualTo "CUP_B_C130J_Cargo_USMC") || (_obj_type isEqualTo "CUP_O_C130J_Cargo_TKA")) then
			{
				if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_C130J, true];};
				if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 10.5, true];};
			}
			else
			{
		...
		if (_obj_type in IL_Supported_Vehicles_V22) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -2.6, true];};
			if ((isNil {_obj getVariable "usable_ramp"}) || (_force)) then {_obj setVariable["usable_ramp", IL_Ramp, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_V22, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 13.2, true];};
		};
		
		if (_obj_type in IL_Supported_Vehicles_V44) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -5.77, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", (IL_Num_Slots_V44), true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 13.2, true];};
		};
		...
		if (_obj_type in IL_Supported_Vehicles_Y32) then
		{
			...
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -2.1, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", (IL_Num_Slots_Y32), true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 14.6, true];};
		};
		...
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "box_num_t"}) || (_force)) then {_obj setVariable["box_num_t", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_OFFROAD, true];};
			if ((isNil {_obj getVariable "slots_num_t"}) || (_force)) then {_obj setVariable["slots_num_t", -2, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -0.7, true];};
			if ((isNil {_obj getVariable "zload_t"}) || (_force)) then {_obj setVariable["zload_t", 0.4, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 1.5, true];};
			if ((isNil {_obj getVariable "load_offset_t"}) || (_force)) then {_obj setVariable["load_offset_t", -0.6, true];};
		};
		...
		if (_obj_type in IL_Supported_Vehicles_KAMAZ) then
		{
			...
			if ((isNil {_obj getVariable "zload_t"}) || (_force)) then {_obj setVariable["zload_t", 0.5, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", -0.5, true];};
			if ((isNil {_obj getVariable "load_offset_t"}) || (_force)) then {_obj setVariable["load_offset_t", -3, true];};
		};
		if (_obj_type in IL_Supported_Vehicles_TEMPEST) then
		{
			...
			if ((isNil {_obj getVariable "zload_t"}) || (_force)) then {_obj setVariable["zload_t", 0.8, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 0.5, true];};
			if ((isNil {_obj getVariable "load_offset_t"}) || (_force)) then {_obj setVariable["load_offset_t", -2.9, true];};
		};
		if (_obj_type in IL_Supported_Vehicles_HEMTT) then
		{
			...
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload_t"}) || (_force)) then {_obj setVariable["zload_t", 0.5, true];};
			if ((isNil {_obj getVariable "load_offset_t"}) || (_force)) then {_obj setVariable["load_offset_t", -4.6, true];};
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_LAV) then
		{
			_obj setVariable["slots", 6, true];
		...
		if (_obj_type in IL_Supported_Vodnik) then
		{
			_obj setVariable["slots", 6, true];
			_obj setVariable["cargo_offset", 2.4, true];
		}; 
		if (_obj_type in IL_Supported_BTR) then
		{
			if (_obj_type isEqualTo "CUP_O_BTR40_MG_TKM") then
			{
				_obj setVariable["slots", 5, true];
				_obj setVariable["cargo_offset", 2.3, true];
			}
			else
			{
				if (_obj_type isEqualTo "CUP_O_BTR60_CSAT") then
				{
					_obj setVariable["slots", 5, true];
		...
		if (_obj_type in IL_Supported_Cars_RU) then
		{
		...
		{
			_obj setVariable["slots", 4, true];
			_obj setVariable["cargo_offset", 1.25, true];
		};
		if (_obj_type in IL_Supported_TT650) then
		{
			_obj setVariable["slots", 2, true];
			_obj setVariable["cargo_offset", 0.3, true];
		};
		if (_obj_type in IL_Supported_HQ) then
		{
			_obj setVariable["slots", 7, true];
			if (_obj_type in ["O_T_APC_Wheeled_02_rcws_ghex_F", "O_APC_Wheeled_02_rcws_F"]) then
			{
				_obj setVariable["slots", 7, true];
				_obj setVariable["cargo_offset", 1.1, true];
			}
			else
			{
				_obj setVariable["cargo_offset", 2.5, true];
		...
		if (_obj_type in IL_Supported_HeavyStatic) then
		{
			_obj setVariable["slots", 3, true];
			_obj setVariable["cargo_offset", 0.4, true];
		};
		if (_obj_type in IL_Supported_Static) then
		{
			_obj setVariable["slots", 2, true];
			if (_obj_type in IL_Supported_Static_Vanilla || _obj_type in ["rhs_KORD_MSV", "CUP_B_TOW_TriPod_USMC"]) then
			{
				_obj setVariable["cargo_offset", 0.9, true];
				if (_obj_type in ["B_GMG_01_A_F", "B_HMG_01_A_F", "O_GMG_01_A_F", "O_HMG_01_A_F", "I_GMG_01_A_F", "I_HMG_01_A_F", "B_GMG_01_F", "B_HMG_01_F", "O_GMG_01_F", "O_HMG_01_F", "I_GMG_01_F", "I_HMG_01_F"]) then
				{
					_obj setVariable["zload_cargo", (_obj getVariable "zload_cargo") - 0.2, true];
				}
			}
			else
			{
				if (_obj_type in IL_Supported_Static_OFPS) then
				{
					_obj setVariable["cargo_offset", 1.2, true];
				}
				else
				{
					if (_obj_type in IL_Supported_Static_CUP) then
					{	
						if (_obj_type in ["CUP_O_DSHKM_ChDKZ", "CUP_O_DSHkM_MiniTriPod_ChDKZ", "CUP_O_Metis_RU"]) then
						{
							_obj setVariable["cargo_offset", 1.2, true];
						}
						else
						{
							if (_obj_type in ["CUP_O_AGS_RU"]) then 
							{
								_obj setVariable["cargo_offset", 1.05, true];
							}
							else
							{
								if (_obj_type in ["CUP_O_SPG9_ChDKZ"]) then 
								{
									_obj setVariable["cargo_offset", 0.3, true];
								}
								else
					...
					{
						if (_obj_type in ["rhs_SPG9M_MSV"]) then 
						{
							_obj setVariable["cargo_offset", 0.3, true];
						}
						else
						{
							if (_obj_type in ["RHS_AGS30_TriPod_MSV"]) then 
							{
								_obj setVariable["cargo_offset", 1.05, true];
							}
							else 
							{
								if (_obj_type in ["RHS_MK19_TriPod_D"]) then 
								{
									_obj setVariable["cargo_offset", 1.3, true];
									_obj setVariable["zload_cargo", (_obj getVariable "zload_cargo") - 0.1, true];
								}
								else 
								{
									if (_obj_type in ["RHS_M2StaticMG_MiniTripod_D"]) then 
									{
										_obj setVariable["cargo_offset", 0.5, true];
										_obj setVariable["zload_cargo", (_obj getVariable "zload_cargo") - 0.1, true];
									}
		...
		if (_obj_type in IL_Supported_Stryker) then
		{
			_obj setVariable["slots", 8, true];
			_obj setVariable["cargo_offset", 2.3, true];
		};
		...
		{
			_obj setVariable["slots", 8, true];
			_obj setVariable["cargo_offset", 2.8, true];
		};
	};
//	END IL_Init_Box
...
//	END IL_Create_And_Attach
	...
	IL_Cargo_Para =
	{
		...
		//[Player, IL_Unload_Score] call IL_Score; // Commented out as we add score below
		
		private ["_smoke", "_light", "_damage", "_smoke_type", "_chemlight_type", "_cargo_pos", "_last_attach_pos", "_dist", "_velocity", "_tmp", "_lastPos", "_lastTown", "_currentTown"];
		_cargo = _this select 0;
		_v = _this select 1;
		
		_lastPos = _cargo getVariable "cti_last_pos";
		if !(isNil "_lastPos") then {
			_lastTown = _cargo getVariable "cti_last_town";
			_currentTown = _cargo call CTI_CO_FNC_GetClosestTown;
			if (_cargo distance2D _lastPos >= CTI_TEAMPLAY_TRANSPORT_DISTANCE && (_cargo distance2D _lastTown >= CTI_TEAMPLAY_TRANSPORT_DISTANCE_TOWN_LAST || isNull _lastTown) && !(_currentTown isEqualTo _lastTown)) then {
				_cargo setVariable ["cti_last_pos", position _cargo, true];
				_cargo setVariable ["cti_last_town", _currentTown, true];
				(CTI_TEAMPLAY_PARADROP_REWARD) call CTI_CL_FNC_ChangePlayerFunds;
				[player, CTI_TEAMPLAY_PARADROP_SCORE] remoteExec ["CTI_PVF_SRV_RequestAddScore", CTI_PV_SERVER];
				["Paradropped Vehicle", "paradrop", CTI_TEAMPLAY_PARADROP_REWARD] call CTI_DisplayReward_Display;
			};
		};
...
//	END IL_Cargo_Para
	...
	IL_Do_Load =
	{
		...
		private["_NoBoxHint", "_v", "_supported_cargo", "_zload", "_zload_t", "_x_cargo_offset", "_cargo_offset", "_cargo_offset_t", "_sdist", "_spoint", "_slot_num", "_counter", "_done", "_obj_lst", "_damage", "_obj_type", "_doors", "_box_num", "_dummy", "_nic", "_turn", "_force", "_cargo"];
		...
		if (!(isNil {_v getVariable "zload_t"})) then {_zload_t = _v getVariable "zload_t";};
		_obj_type = (typeOf _v);
		_sdist = 0;
		...
		if ((_obj_type in IL_Supported_Vehicles_OFFROAD) && (_doors isEqualTo "T")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
			...
			_box_num = _v getVariable "box_num_t";
			_slot_num = _v getVariable "slots_num_t";
		};
		...
		if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors isEqualTo "T")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors isEqualTo "T")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors isEqualTo "T")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		if ((_obj_type in IL_Supported_Vehicles_C130J) && (_doors isEqualTo "B")) then
		{
			...
			_spoint = _v modelToWorld [0,-11,-5.4];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		if ((_obj_type in IL_Supported_Vehicles_V22) && (_doors isEqualTo "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
			...
			_sdist = IL_SDistL + IL_SDistL_Heli_offset;
			_spoint = _v modelToWorld [0,-11,-2.4];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		
		if ((_obj_type in IL_Supported_Vehicles_V44) && (_doors isEqualTo "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
		...
		if ((_obj_type in IL_Supported_Vehicles_Y32) && (_doors isEqualTo "B")) then
		{
			if (IL_DevMod) then
			{
				Player globalChat Format ["IgiLoad ""%1"". Do_load vehicle type: ""%2"" and doors: ""%3""", IL_Script_Inst, _obj_type, _doors];
			...
			_sdist = IL_SDistL + IL_SDistL_Heli_offset;
			_spoint = _v modelToWorld [0,-8.5,-2.4];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		...
		{
			{
				...
				{
					_turn = false; // Changed to false. No need for it to be true, really
				};
				...
				else
				{
					...
					if ((_box_num > _slot_num) && !_done) then
					{
						...
						if (!(isNil {_v getVariable "zload_t"})) then 
						{
							_zload_t = (_v getVariable "zload_t")  + (_x getVariable "zload_cargo");
							if (typeOf _x in IL_Supported_Static_Raised && !(_obj_type in IL_Supported_Vehicles_OFFROAD)) then 
							{
								_zload_t = _zload_t - 0.8;
							};
						};
						
						
						_cargo_offset = (_v getVariable "load_offset") + (_x getVariable "cargo_offset");
						if (!(isNil {_v getVariable "load_offset_t"})) then {_cargo_offset_t = (_v getVariable "load_offset_t") + (_x getVariable "cargo_offset");};
						if (IL_DevMod) then
						{
							Player globalChat Format ["IgiLoad ""%1"". Load Offset ""%2"". Cargo Offset: ""%3"". Class name: ""%4""", IL_Script_Inst, _v getVariable "load_offset", _x getVariable "cargo_offset", typeOf _x];
						};
						...
						{
							if ((typeOf _x) in ["B_static_AT_F", "O_static_AT_F", "I_static_AT_F", "B_static_AA_F", "O_static_AA_F", "I_static_AA_F"]) then
							{
								_x_cargo_offset = -0.05;
							}
							else
							{
								if ((typeOf _x) in IL_Supported_Static_Vanilla) then
								{
								_x_cargo_offset = 0.15;
								}
								else
								{
									if ((typeOf _x) in IL_Supported_Static_OFPS) then 
									{ 
										_x_cargo_offset = -0.05;
									}
									else
									{
										if ((typeOf _x) in ["O_T_APC_Wheeled_02_rcws_ghex_F", "O_APC_Wheeled_02_rcws_F"]) then 
										{ 
											_x_cargo_offset = -0.3;
										}
										else
										{
											if ((typeOf _x) in IL_Supported_UAZ) then 
											{ 
												_x_cargo_offset = -0.07;
											}
											else
											{
												if ((typeOf _x) in ["CUP_B_M2StaticMG_USMC", "rhs_Igla_AA_pod_msv"]) then 
												{ 
													_x_cargo_offset = 0.32;
												}
												else
												{
													if ((typeOf _x) in IL_Supported_HeavyStatic || (typeOf _x) in ["CUP_O_Metis_RU"]) then 
													{ 
														_x_cargo_offset = -0.17;
													}
													else
													{
														if ((typeOf _x) in ["CUP_O_DSHKM_ChDKZ", "CUP_O_DSHkM_MiniTriPod_ChDKZ", "RHS_AGS30_TriPod_MSV", "rhs_KORD_MSV"]) then 
														{ 
															_x_cargo_offset = 0.21;
														}
														else
														{
															_x_cargo_offset = 0;
						...
						if ((_obj_type in IL_Supported_Vehicles_OFFROAD) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,3,_zload], [_x_cargo_offset, -_cargo_offset_t,_zload_t], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors isEqualTo "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,6,_zload], [_x_cargo_offset, -_cargo_offset_t,_zload_t], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors isEqualTo "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,7,_zload], [_x_cargo_offset,-_cargo_offset_t,_zload_t], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors isEqualTo "B")) then
						{
							[_v, _x, [_x_cargo_offset,-6.5 - _cargo_offset,_zload], [_x_cargo_offset,(_counter * 0.8) - _cargo_offset ,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,6.5,_zload], [_x_cargo_offset,-_cargo_offset_t,_zload_t], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_C130J)  && (_doors isEqualTo "B")) then
						{
							[_v, _x, [_x_cargo_offset,-11,-0.93 + _zload], [_x_cargo_offset,-8,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
						...
						if ((_obj_type in IL_Supported_Vehicles_V44)  && (_doors isEqualTo "B")) then
						{
							...
							[_v, _x, [_x_cargo_offset,-7,-0.93 + _zload], [_x_cargo_offset,-3.5,_zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-2.5,_zload], [_x_cargo_offset,_counter + 19 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_Y32)  && (_doors isEqualTo "B")) then
						{
							[_v, _x, [_x_cargo_offset,-8.5,-0.93 + _zload], [_x_cargo_offset,-7.5,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-6.5,-0.93 + _zload], [_x_cargo_offset,-3.5,_zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-2.5,_zload], [_x_cargo_offset,_counter + 17 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_C17)  && (_doors isEqualTo "B")) then
						{
						...
						if (_obj_type in (IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_TEMPEST)  && (_doors isEqualTo "T")) then
						{
							_v setVariable["box_num_t", _counter, true];
							_v setVariable["box_t", _x, true];
						};
...
//	END IL_Do_Load
	...
	IL_Do_Unload =
	{
		...
		private ["_v", "_para", "_supported_cargo", "_doors", "_counter", "_done", "_obj_lst", "_zload", "_zload_t", "_x_cargo_offset", "_cargo_offset", "_cargo_offset_t", "_obj_type", "_damage", "_nic", "_free_slots", "_turn", "_skip", "_last_attach_pos"];
		_v = _this select 0;
		...
		else
		{
			if (_obj_type in (IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_TEMPEST) && _doors isEqualTo "T") then
			{
				_obj_lst = [_v getVariable "box_t"];
			}
			else
			{		
//				_obj_lst = nearestObjects[_v, _supported_cargo, IL_SDistU];
				_obj_lst = attachedObjects _v;
				/* if (_obj_type in IL_Supported_Vehicles_OFFROAD && count [_v getVariable "box_t"] > 0) then
				{
					_obj_lst = obj_list - [_v getVariable "box_t"];
				}; */
			};
		};
		...
		{
			{
				...
				if (_x getVariable "doors" isEqualTo _doors) then
				{
					...
					if (_doors isEqualTo "T") then
					{
						_counter = (_v getVariable "box_num_t");
					};
					if (((_x getVariable "attachedTruck") isEqualTo _v) && ((_x getVariable "attachedPos") isEqualTo (_counter)) && (_counter < 0) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_OFFROAD) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,1.5 - _cargo_offset_t,_zload_t - 0.55], [_x_cargo_offset,5,_zload_t - 0.55], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors isEqualTo "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_KAMAZ) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,1.5 - _cargo_offset_t,_zload_t], [_x_cargo_offset,6,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors isEqualTo "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_HEMTT) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,1.5 - _cargo_offset_t,_zload_t - 0.55], [_x_cargo_offset,7,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors isEqualTo "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_TEMPEST) && (_doors isEqualTo "T")) then
						{
							[_v, _x, [_x_cargo_offset,1.5 - _cargo_offset_t,_zload_t - 0.55], [_x_cargo_offset,6.5,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_C130J)  && (_doors isEqualTo "B")) then
						{
							if !(_para) then
							{
								[_v, _x, [_x_cargo_offset,_counter + 17 - _cargo_offset,_zload], [_x_cargo_offset,-3.5,_zload], 1, _turn] call IL_Move_Attach;
							};
							[_v, _x, [_x_cargo_offset,-3.5,_zload], [_x_cargo_offset,-7,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-8,-0.93 + _zload], [_x_cargo_offset,-11,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
							if ((_para) && (_obj_type in IL_Para_Drop_Vehicles)) then
							{
								[_v, _x, [_x_cargo_offset,-11,-0.93 + _zload], [_x_cargo_offset,-13,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
								_last_attach_pos = [_x_cargo_offset,-13,_zload];
							};
						};
						if ((_obj_type in IL_Supported_Vehicles_V22)  && (_doors isEqualTo "B")) then
						{
						...
						if ((_obj_type in IL_Supported_Vehicles_Y32)  && (_doors isEqualTo "B")) then
						{
							...
							[_v, _x, [_x_cargo_offset,-3.5,_zload], [_x_cargo_offset,-6.5,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-7.5,-0.93 + _zload], [_x_cargo_offset,-8.5,-0.93 + _zload], 1, _turn] call IL_Move_Attach;
							if ((_para) && (_obj_type in IL_Para_Drop_Vehicles)) then
							{
						...
						{
							_v setVariable["box_num_t", _counter, true];
							_v setVariable["box_t", _v, true];
							_free_slots = abs((_v getVariable "slots_num_t") - (_v getVariable "box_num_t"));
						};
...
//	END IL_Do_Unload
	...
	IL_GetOut =
	{
		...
		if ((typeOf _v) in IL_Supported_Vehicles_V22) then
		{
			_dist_out = 7;
			_dist_out_para = 15;
		};
		if ((typeOf _v) in IL_Supported_Vehicles_V44) then
		{
			_dist_out = 7;
			_dist_out_para = 15;
		};
...
//		"('cargo' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	"(count(nearestObjects[ _target modelToWorld [0,-11,-5.4], IL_Supported_Cargo_NonVeh_C130J, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-11,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' isEqualTo 1) && (_target animationPhase 'ramp_top' isEqualTo 1)"
	];
	...
	"(count(nearestObjects[ _target modelToWorld [0,-11,-5.4], IL_Supported_Cargo_Veh_C130J, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-11,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' isEqualTo 1) && (_target animationPhase 'ramp_top' isEqualTo 1)"
	];
...
if (_obj_main_type in IL_Supported_Vehicles_V22) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_V22.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	
	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on V-22 Osprey</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_V22] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-11,-2.4], IL_Supported_Cargo_NonVeh_V22, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-11,-2.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' isEqualTo 1) && (_target animationPhase 'ramp_top' isEqualTo 1)"
	];

	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on V-22 Osprey</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_V22] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-11,-2.4], IL_Supported_Cargo_Veh_V22, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-11,-2.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' isEqualTo 1) && (_target animationPhase 'ramp_top' isEqualTo 1)"
	];

	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from V-22 Osprey</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-11,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'ramp_bottom' isEqualTo 1) && (_target animationPhase 'ramp_top' isEqualTo 1)"
...
if (_obj_main_type in IL_Supported_Vehicles_V44) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_V44.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	...
	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on V-44 X Blackfish</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_V44] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-9,-5.4], IL_Supported_Cargo_NonVeh_V44, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt)"
	];

	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on  V-44 X Blackfish</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_V44] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-9,-5.4], IL_Supported_Cargo_Veh_V44, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt)"
	];

	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from  V-44 X Blackfish</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	...
	"(_target getVariable 'box_num' < 0) && ((driver _target isEqualTo _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'can_load') && (((getPosATL _target) select 2) >= IL_Para_Drop_ATL)"
	];
...
if (_obj_main_type in IL_Supported_Vehicles_Y32) then
{
	if (IL_DevMod) then
	{
		Player globalChat Format["IgiLoad ""%1"" Vehicle is in IL_Supported_Vehicles_Y32.", IL_Script_Inst];
	};
	_vsupported = true;
	[_obj_main] call IL_Init_Veh;
	...
	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load cargo on Y-32 Xi'an</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_Y32] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-8.5,-2.4], IL_Supported_Cargo_NonVeh_Y32, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-8.5,-2.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt)"
	];

	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load vehicle on  Y-32 Xi'an</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_Y32] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-8.5,-2.4], IL_Supported_Cargo_Veh_Y32, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-8.5,-2.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt)"
	];

	_obj_main addAction [
	"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload cargo from  Y-32 Xi'an</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this isEqualTo _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-8,-5.4], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt)"
	];
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-5,0], IL_Supported_Cargo_NonVeh_OFFROAD, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	...
	"(count(nearestObjects[ _target modelToWorld [0,-5,0], IL_Supported_Cargo_Veh_OFFROAD, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	...
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-5,0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
	];
	...
	{
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load static on top of Offroad</t>",
		{
			[_this select 0, IL_Supported_Static, "T"] call IL_Do_Load;
		},[],IL_Action_LU_Priority,true,true,"",
		"(count(nearestObjects[ _target modelToWorld [0,5,0.5], IL_Supported_Static, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,5,0.5], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num_t') && (_target getVariable 'can_load')" 
		];
		
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload static from top of Offroad</t>",
		{
			[_this select 0, false, "T"] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		"(_target getVariable 'box_num_t' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,5,0.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
		];
	};
};
...
if (_obj_main_type in IL_Supported_Vehicles_KAMAZ) then
{
	...
	{
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load static on top of ZAMAK</t>",
		{
			[_this select 0, IL_Supported_Static, "T"] call IL_Do_Load;
		},[],IL_Action_LU_Priority,true,true,"",
		"(count(nearestObjects[ _target modelToWorld [0,6 - (_target getVariable 'load_offset'),0], IL_Supported_Static, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,6 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num_t' > _target getVariable 'slots_num_t') && (_target getVariable 'can_load')" 
		];
		
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload static from top of ZAMAK</t>",
		{
			[_this select 0, false, "T"] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		"(_target getVariable 'box_num_t' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,6 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
		];
	};
};
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	{
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load static on top of TEMPEST</t>",
		{
			[_this select 0, IL_Supported_Static, "T"] call IL_Do_Load;
		},[],IL_Action_LU_Priority,true,true,"",
		"(count(nearestObjects[ _target modelToWorld [0,6.5 - (_target getVariable 'load_offset'),0], IL_Supported_Static, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num_t' > _target getVariable 'slots_num_t') && (_target getVariable 'can_load')" 
		];
		
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload static from top of TEMPEST</t>",
		{
			[_this select 0, false, "T"] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		"(_target getVariable 'box_num_t' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,6.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
		];
	};
};
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	{
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load static on top of HEMTT</t>",
		{
			[_this select 0, IL_Supported_Static, "T"] call IL_Do_Load;
		},[],IL_Action_LU_Priority,true,true,"",
		"(count(nearestObjects[ _target modelToWorld [0,7 - (_target getVariable 'load_offset'),0], IL_Supported_Static, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num_t' > _target getVariable 'slots_num_t') && (_target getVariable 'can_load')" 
		];
		
		_obj_main addAction [
		"<img image='Client\Functions\Externals\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload static from top of HEMTT</t>",
		{
			[_this select 0, false, "T"] call IL_Do_Unload;
		},[],IL_Action_LU_Priority,false,true,"",
		"(_target getVariable 'box_num_t' < 0) && ((IL_Can_Inside && (driver _target isEqualTo _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,7 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed)"
		];
	};
};
