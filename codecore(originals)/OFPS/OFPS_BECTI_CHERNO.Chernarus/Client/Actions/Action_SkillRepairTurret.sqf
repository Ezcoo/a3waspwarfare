private ["_vehicles","_repairType","_repairProgress","_vehicle","_actiontime","_startTime","_totaltime","_animation","_hitPoints","_hitPoints_repair"];
...
_repairType = "Vehicle Turret";
/*_progressDisplay = uiNamespace getVariable "cti_dialog_ui_repairProgress"; 
_progressBar = _progressDisplay displayCtrl 800001;
_progressText = _progressDisplay displayCtrl 800002; */
_repairProgress = 0;
