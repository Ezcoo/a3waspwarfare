...
class CTI_RscPurchaseMenu {
	...
	class controls {
		...
		class CTI_Icon_Air_Rotary: CTI_Icon_Barracks
		{
			...
			text = "Rsc\Pictures\icon_wf_building_air_rotary.paa"; //--- ToDo: Localize;
		...
		class CTI_Icon_Air_Fixed: CTI_Icon_Barracks
		{
			...
			text = "Rsc\Pictures\icon_wf_building_air_fixed.paa"; //--- ToDo: Localize;
		...
		class CTI_Menu_StatListContainer: RscControlsGroup
		{
			idc = 110021;
...
class CTI_RscGearMenu
{
	...
	class controlsBackground {
		...
		class CTI_Menu_Title: RscText
		{
			...
			y = 0.0075 * safezoneH + safezoneY;
			w = 0.5 * safezoneW;
			h = 0.04 * safezoneH;
			colorText[] = {0.258824,0.713726,1,1};
			sizeEx = "1.5 * (			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
		};
		...
		class CTI_Menu_MagsList_Frame: RscFrame
		{
			x = 0.405 * safezoneW + safezoneX;
			y = 0.53 * safezoneH + safezoneY;
			w = 0.28 * safezoneW;
		...
		class CTI_Menu_Items_Unit_Frame: RscFrame
		{
			x = 0.405 * safezoneW + safezoneX;
			y = 0.25 * safezoneH + safezoneY;
			w = 0.28 * safezoneW;
	...
	class controls {
		...
		class CTI_Gear_Container_Secondary_Optics: CTI_Gear_Container_Secondary_Muzzle
		{
			...
			x = 0.84625 * safezoneW + safezoneX;
			y = 0.515 * safezoneH + safezoneY;
			w = 0.070625 * safezoneW;
			h = 0.07 * safezoneH;
			colorBackground[] = {1,1,1,0.15};
		};
		// Was already not within display bounds (not sure if intended), so it is now commented out
		...
		class CTI_Gear_Container_Secondary_CurrentMagazine: CTI_Gear_Container_Secondary_Muzzle
		{
			...
			x = 0.919375 * safezoneW + safezoneX;
			y = 0.515 * safezoneH + safezoneY;
			w = 0.070625 * safezoneW;
			h = 0.07 * safezoneH;
			colorBackground[] = {1,1,1,0.15};
		...
		class CTI_Gear_Control_Linked_Items: CTI_Gear_Control_Items_Purchase
		{
			...
			onLBDrag = "['onShoppingListLBDrag', _this select 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'";
			onLBSelChanged = "['onLinkedListLBSelChanged', _this select 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'";
		...
		class CTI_Gear_Control_Primary: CTI_Gear_Control_Uniform
		{
			...
			onMouseButtonClick = "if (_this select 1 == 1) then {['onWeaponRightClicked', 0] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'};";
			onMouseButtonDblClick = "['onShoppingTabClicked', CTI_GEAR_TAB_PRIMARY] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'";
			onMouseButtonDown = "";
		...
		class CTI_Gear_Control_Secondary: CTI_Gear_Control_Primary
		{
			...
			onMouseButtonClick = "if (_this select 1 == 1) then {['onWeaponRightClicked', 1] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'};";
			onMouseButtonDblClick = "['onShoppingTabClicked', CTI_GEAR_TAB_SECONDARY] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'";
			onMouseButtonDown = "";
		...
		class CTI_Gear_Control_Pistol: CTI_Gear_Control_Primary
		{
			...
			onMouseButtonClick = "if (_this select 1 == 1) then {['onWeaponRightClicked', 2] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'};";
			onMouseButtonDblClick = "['onShoppingTabClicked', CTI_GEAR_TAB_HANDGUN] call compile preprocessFileLineNumbers 'Client\Events\Events_UI_GearMenu.sqf'";
			onMouseButtonDown = "";
		...
		class CTI_Gear_Control_Buy: CTI_Gear_Control_CreateTemplate
		{
			...
			w = 0.29 * safezoneW;
			h = 0.055 * safezoneH;
			colorBackground[] = {0,0.60,0,.9}; // Dark Orange
			colorBackgroundActive[] = {0,0.75,0,.9}; // Lighter Dark Orange
		...
		class CTI_Gear_Control_RenameTemplateButton: CTI_Gear_Control_CreateTemplate
		{
			idc = 71121;
...
class CTI_RscVideoSettingsMenu {
	...
	class controls {
		...
		class CTI_Control_Back : CTI_Control_Exit {
			...
			text = "<<";
			action = "closeDialog 0; createDialog 'CTI_RscTabletDialogOptions';";
		};
	};
};
...
class CTI_RscTeamsMenu {
	...
	class controlsBackground {
		...
		class CTI_Control_Back : CTI_Control_Exit {
			...
			text = "<<";
			action = "closeDialog 0; createDialog 'CTI_RscTabletCommandMenu';";
		};
	};
...
class CTI_RscServiceMenu {
	...
	class controls {
		...
		class CTI_Menu_Control_Sell: RscButton
		{
			idc = 230008;
...
class CTI_RscVoteMenu {
	...
	class controls {
		...
		class CTI_Menu_Vote_Confirm : RscButton {
			idc = 300005;
...
class CTI_RscDefenseMenu
{
	...
	class controls
	{
		...
		class CTI_RscDefenseList: RscListNBox
		{
			idc = 785006;
		...
		class CTI_RscDefenseText: RscStructuredText
		{
			type = CT_STRUCTURED_TEXT;
			style = ST_MULTI;
			text = ""; //--- ToDo: Localize;
...
class CTI_RscLoadoutMenu
{
	...
	class controls
	{
		...
		class CTI_RscLoadoutMenu_Customizations: RscListNBox
		{
			idc = 790025;
		...
		class CTI_RscLoadoutMenu_Custom_Clear: RscButton
		{
			idc = 790026;
		...
		class CTI_RscLoadoutMenu_Custom_Purchase: RscButton
		{
			idc = 790027;
		...
		class CTI_RscLoadoutMenu_ClearPrice: RscStructuredText
		{
			idc = 790028;
		...
		class CTI_RscLoadoutMenu_Templates: RscListNBox
		{
			idc = 790029;
		...
		class CTI_RscLoadoutMenu_Template_Delete: RscButton
		{
			idc = 790030;
		...
		class CTI_RscLoadoutMenu_TemplateRenameInput: RscEdit
		{
			idc = 790031;
			text = "Enter a new template name..."; //--- ToDo: Localize;
			x = 0.0359375 * safezoneW + safezoneX;
		...
		class CTI_RscLoadoutMenu_Template_Create: RscButton
		{
			idc = 790032;
		...
		class CTI_RscLoadoutMenu_Template_Rename: RscButton
		{
			idc = 790033;
		...
		class CTI_RscLoadoutMenu_Template_Title: RscStructuredText
		{
			idc = 790034;
		...
		class CTI_RscLoadoutMenu_Customizations_Title: RscStructuredText
		{
			idc = 790035;
		...
		class CTI_RscLoadoutMenu_Credit: RscStructuredText
		{
			idc = 790036;
		...
		class CTI_RscLoadoutMenu_ClearMagPrice: RscStructuredText
		{
			idc = 790037;
		...
		class CTI_RscLoadoutMenu_ClearMag: RscButton
		{
			idc = 790038;
