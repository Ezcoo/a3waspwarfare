...
if ((count _this) > 7) then {
	if (typeName (_this select 7) == "SCALAR") then {
		switch (_this select 7) do {
			case 0: {intEFX = 0;arSands_MKY = [-0.02,-0.01,0,0.01,0.02,5];};
			case 1: {intEFX = -0.02;arSands_MKY = [-0.01,5];arSandColors_MKY resize 3;arSandsVolume_MKY deleteAt 2};
			case 2: {intEFX = 0;arSands_MKY = [-0.01,0,0.01,5];arSandColors_MKY deleteAt 5;arSandColors_MKY deleteAt 0;arSandsVolume_MKY deleteAt 2};
			case 3: {intEFX = 0.01;arSands_MKY = [0,0.01,0.02,5];arSandColors_MKY deleteAt 5;arSandColors_MKY deleteAt 4;};
			case 4: {intEFX = 4;};
			default {intEFX = -0.02;arSands_MKY = [-0.01,5];arSandColors_MKY resize 4;arSandsVolume_MKY deleteAt 2};
		};
	};
};
