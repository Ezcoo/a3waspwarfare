...
if (_assist) then {
	...
	Format[Localize "STR_WF_CHAT_Award_Bounty_Assist", _bounty, _name] Call WFBE_CL_FNC_GroupChatMessage;
} else {
	Format[Localize "STR_WF_CHAT_Award_Bounty", _bounty, _name] Call WFBE_CL_FNC_GroupChatMessage;
};
