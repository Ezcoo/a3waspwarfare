...
_income = (_side) Call WFBE_CO_FNC_GetTownsIncome;
...
_team_count = (_logik getVariable "wfbe_teams_count");
					
/*if(_team_count > 0) then {
	_commanderPercent = (_logik getVariable "wfbe_commander_percent") / 100;	
...
//missionNamespace getVariable "WFBE_C_ECONOMY_INCOME_COEF";
