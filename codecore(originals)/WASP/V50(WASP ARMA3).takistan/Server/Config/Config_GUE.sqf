...
missionNamespace setVariable ['WFBE_GUERRESCREW','CUP_I_TK_GUE_Mechanic'];
missionNamespace setVariable ['WFBE_GUERRESSOLDIER','CUP_I_TK_GUE_Soldier'];
missionNamespace setVariable ['WFBE_GUERRESPILOT','CUP_I_TK_GUE_Mechanic'];