...
[str _side,'VehiclesCreated',1] Call WFBE_CO_FNC_UpdateStatistics;
...
[_grp,(_args select 2),"MOVE",10] Call WFBE_SE_FNC_AIMoveTo;
...
[_grp,(_ranPos select _ran),"MOVE",10] Call WFBE_SE_FNC_AIMoveTo;
