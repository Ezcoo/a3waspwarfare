...
if (_unitType isKindOf "Man") then {
	...
	[_sideText,'UnitsCreated',1] Call WFBE_CO_FNC_UpdateStatistics;
} else {
	...
	[_sideText,'VehiclesCreated',1] Call WFBE_CO_FNC_UpdateStatistics;
	_built = 1;
...
_vehicle allowCrewInImmobile true;
	[_sideText,'UnitsCreated',_built] Call WFBE_CO_FNC_UpdateStatistics;
};
