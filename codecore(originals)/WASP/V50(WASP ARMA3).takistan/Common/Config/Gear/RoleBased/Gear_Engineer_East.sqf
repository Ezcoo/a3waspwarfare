...
[_faction, _i, _u, _p, WSW_ENGINEER] call compile preprocessFileLineNumbers "Common\Config\Gear\Gear_Role_Config_Set.sqf";

// todo: verify useful reasons to keep here code lines below
_t = [];

[_faction, _t, WSW_ENGINEER] call compile preprocessFileLineNumbers "Common\Config\Gear\Gear_Role_Template_Set.sqf";