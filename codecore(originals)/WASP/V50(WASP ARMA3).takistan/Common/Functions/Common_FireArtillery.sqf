...
_index = [typeOf _artillery, _side] Call WFBE_CO_FNC_IsArtillery;
...
_magazine = (missionNamespace getVariable Format ["WFBE_%1_ARTILLERY_MAGAZINES",_side]) select _index;

[_artillery] Call WFBE_CO_FNC_ARTY_Prep; //--- Prepare the artillery unit to the fire mission submission.
...
[_artillery] Call WFBE_CO_FNC_ARTY_Finish; //--- Free the artillery unit from the fire mission submission.
sleep 5;
