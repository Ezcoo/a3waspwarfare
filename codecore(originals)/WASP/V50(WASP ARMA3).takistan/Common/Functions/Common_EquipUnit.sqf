...
_accessories = (_new select 1) call WFBE_CO_FNC_ArrayToLower;
...
if (_item != "") then {
	_accessories_current = (primaryWeaponItems _unit) call WFBE_CO_FNC_ArrayToLower;
...
if (_item != "") then {
	_accessories_current = (secondaryWeaponItems _unit) call WFBE_CO_FNC_ArrayToLower;
...
if (_item != "") then {
	_accessories_current = (handgunItems _unit) call WFBE_CO_FNC_ArrayToLower;
...
if (((_gear select 1) select 2) select 0 != backpack _unit || [((_gear select 1) select 2) select 1, backpackItems _unit] call WFBE_CO_FNC_ArrayDiffers) then {
	[_unit, ((_gear select 1) select 2) select 0, ((_gear select 1) select 2) select 1] call WFBE_CO_FNC_EquipContainerBackpack;
};
if (((_gear select 1) select 1) select 0 != vest _unit || [((_gear select 1) select 1) select 1, vestItems _unit] call WFBE_CO_FNC_ArrayDiffers) then {
	[_unit, ((_gear select 1) select 1) select 0, ((_gear select 1) select 1) select 1] call WFBE_CO_FNC_EquipContainerVest;
};
if (((_gear select 1) select 0) select 0 != uniform _unit || [((_gear select 1) select 0) select 1, uniformItems _unit] call WFBE_CO_FNC_ArrayDiffers) then {
	[_unit, ((_gear select 1) select 0) select 0, ((_gear select 1) select 0) select 1] call WFBE_CO_FNC_EquipContainerUniform;
};
