...
_closest = objNull;
_structures = [_type, _structures] call WFBE_CO_FNC_GetSideStructuresByType;

if (count _structures > 0) then { _closest = [_center, _structures] call WFBE_CO_FNC_GetClosestEntity };
