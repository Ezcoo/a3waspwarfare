...
//--- Units.
	...
	WFBE_C_STATIC_DEFENCE_FOR_COMPOSITIONS = ['rhsgref_nat_DSHKM','CUP_I_2b14_82mm_TK_GUE'];
	...
	WFBE_C_INFANTRY_TO_REQUIP = [['rhs_vdv_flora_at', ['AK-74M', '9M131'], ['7H10 30 AK-74 x8', 'RGN x1', '9M131 x1']],['rhs_vdv_des_at', ['AK-74M', '9M131'], ['7H10 30 AK-74 x8', 'RGN x1', '9M131 x1']],
		['rhs_vdv_flora_machinegunner', [], []], ['rhs_vdv_machinegunner', [], []], ['rhs_msv_machinegunner', [], []], ['rhs_msv_arifleman', [], []], 
    ...
    WFBE_C_ADV_AIR_DEFENCE = ["pook_SA21_static_base", "B_SAM_System_02_F"];
