...
_units = [_artygroup,false,_index,cti_Client_SideJoinedText] Call EZC_fnc_Functions_Common_GetTeamArtillery;
...
for [{_count = count _units - 1},{_count >= 0},{_count = _count - 1}] do {
	[_units select _count,_destination,cti_Client_SideJoined,artyRange,_index] Spawn EZC_fnc_Functions_Common_FireArtillery;
};
