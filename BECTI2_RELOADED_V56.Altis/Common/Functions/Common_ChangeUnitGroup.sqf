...
_units = (units group _unit) Call EZC_fnc_Functions_Common_GetLiveUnits;
...
if ((count _units) < 2) then {_entitie = [missionNamespace getVariable Format ["cti_%1SOLDIER", _side], group _unit, [0,0,0], _side, false] Call EZC_fnc_Functions_Common_CreateUnit};
[_unit] join _group;
