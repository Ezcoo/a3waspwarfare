...
["INFORMATION", Format ["Common_CreateUnit.sqf: [%1] Unit [%2] was created at [%3] and has been assigned to team [%4]", _side Call EZC_fnc_Functions_Common_GetSideFromID, _type, _position, _group]] Call EZC_fnc_Functions_Common_LogContent;
