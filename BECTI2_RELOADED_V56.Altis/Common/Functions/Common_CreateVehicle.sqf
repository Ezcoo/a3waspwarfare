...
["INFORMATION", Format ["Common_CreateVehicle.sqf: [%1] Vehicle [%2] was created at [%3].", _side Call EZC_fnc_Functions_Common_GetSideFromID, _type, _position]] Call EZC_fnc_Functions_Common_LogContent;
