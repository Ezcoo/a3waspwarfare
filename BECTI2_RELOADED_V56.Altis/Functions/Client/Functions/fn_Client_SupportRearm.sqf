...
_supportRange = missionNamespace getVariable "cti_C_UNITS_SUPPORT_RANGE";
...
_rearmTime = missionNamespace getVariable "cti_C_UNITS_SUPPORT_REARM_TIME";
...
_nearIsRT = false;
{
	...
	if ((typeOf _x) == cti_Logic_Depot) then {_nearIsDP = true};
