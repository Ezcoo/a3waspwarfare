/*
  # HEADER #
	...
	Alias:			EZC_fnc_Functions_Common_ArrayPush
  ...
  # SYNTAX #
	[ARRAY, VALUE] call EZC_fnc_Functions_Common_ArrayPush
	
  # EXAMPLE #
	_myArray = [0];
	[_myArray, 1] call EZC_fnc_Functions_Common_ArrayPush; -> [0, 1]
	[_myArray, west] call EZC_fnc_Functions_Common_ArrayPush; -> [0, 1, west]
*/
