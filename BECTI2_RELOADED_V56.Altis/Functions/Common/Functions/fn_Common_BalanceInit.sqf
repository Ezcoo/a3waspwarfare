...
liner
	...
	case "RHS_M2A3_BUSKIII_wd": {
		...
		_current_heavy_level = ((side player) Call EZC_fnc_Functions_Common_GetSideUpgrades) select cti_UP_HEAVY;
	...
	case "CUP_B_LAV25_USMC":{
    	_current_light_level = ((side player) Call EZC_fnc_Functions_Common_GetSideUpgrades) select cti_UP_LIGHT;
