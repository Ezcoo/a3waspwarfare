...
if (WFBE_Client_SideJoined == west) then {(west) call compile preprocessFileLineNumbers "Common\Config\Gear\Gear_CHRONIC_West.sqf"};
if (WFBE_Client_SideJoined == east) then {(east) call compile preprocessFileLineNumbers "Common\Config\Gear\Gear_CHRONIC_East.sqf"};
 

if (WFBE_Client_SideJoined == west) then {(west) call compile preprocessFileLineNumbers "Common\Config\Gear\Gear_CHRONIC_Common.sqf"};
if (WFBE_Client_SideJoined == east) then {(east) call compile preprocessFileLineNumbers "Common\Config\Gear\Gear_CHRONIC_Common.sqf"};
