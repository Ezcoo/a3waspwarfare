...
['TacticalLaunch'] remoteExecCall ["WFBE_CL_FNC_LocalizeMessage"];

//if (isMultiplayer) then {(localize "STR_WF_CHAT_ICBM_Launch") Call WFBE_CL_FNC_CommandChatMessage};

sleep (missionNamespace getVariable "WFBE_C_INCOME_TIME_OF_ICBM");
...
["ICBM",WFBE_Client_SideJoined,_target,_cruise,WFBE_Client_Team] remoteExecCall ["WFBE_SE_PVF_RequestSpecial",2];

sleep 1.5;

["icbm-display", _target, _cruise] remoteExecCall ["WFBE_CL_FNC_HandleSpecial"];
