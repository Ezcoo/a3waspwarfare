...
if(isNil '_special')then{
    [_side, _unitType, _position, _team, _dir] call WFBE_CO_FNC_CreateUnitsForResBases;
} else {
    [_side, _unitType, _position, _team, _dir, _special] call WFBE_CO_FNC_CreateUnitsForResBases;
};
