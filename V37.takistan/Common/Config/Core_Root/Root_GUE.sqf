...
//--- Generic.
missionNamespace setVariable [Format["WFBE_%1CREW", _side], 'CUP_I_TK_GUE_Mechanic'];
missionNamespace setVariable [Format["WFBE_%1PILOT", _side], 'CUP_I_TK_GUE_Mechanic'];
missionNamespace setVariable [Format["WFBE_%1SOLDIER", _side], 'CUP_I_TK_GUE_Soldier'];

//--- Flag texture.
missionNamespace setVariable [Format["WFBE_%1FLAG", _side], '\ca\data\Flag_napa_co.paa'];

missionNamespace setVariable [Format["WFBE_%1AMBULANCES", _side], ['CUP_I_BMP2_AMB_NAPA']];
missionNamespace setVariable [Format["WFBE_%1REPAIRTRUCKS", _side], ['CUP_I_V3S_Repair_TKG']];
...
//--- Paratroopers.
missionNamespace setVariable [Format["WFBE_%1PARACHUTELEVEL1", _side],['rhsgref_nat_rifleman_aks74','rhsgref_nat_grenadier_rpg','rhsgref_nat_rifleman','rhsgref_nat_rifleman_akms','CUP_I_GUE_Soldier_AR','CUP_I_GUE_Medic']];
missionNamespace setVariable [Format["WFBE_%1PARACHUTELEVEL2", _side],['rhsgref_nat_rifleman_aks74','rhsgref_nat_grenadier_rpg','rhsgref_nat_grenadier_rpg','rhsgref_nat_grenadier_rpg','rhsgref_nat_specialist_aa','CUP_I_GUE_Soldier_MG','CUP_I_GUE_Medic','rhsgref_nat_scout','CUP_I_GUE_Sniper']];
missionNamespace setVariable [Format["WFBE_%1PARACHUTELEVEL3", _side],['rhsgref_nat_rifleman_aks74','rhsgref_nat_grenadier_rpg','rhsgref_nat_grenadier_rpg','rhsgref_nat_grenadier_rpg','rhsgref_nat_grenadier_rpg','rhsgref_nat_specialist_aa','rhsgref_nat_specialist_aa','CUP_I_GUE_Soldier_AR','CUP_I_GUE_Medic','rhsgref_nat_scout','rhsgref_nat_grenadier_rpg','CUP_I_GUE_Sniper']];

missionNamespace setVariable [Format["WFBE_%1PARACARGO", _side], 'rhsgref_ins_g_mi8amt'];	//--- Paratroopers, Vehicle.
missionNamespace setVariable [Format["WFBE_%1REPAIRTRUCK", _side], 'CUP_I_V3S_Repair_TKG'];//--- Repair Truck model.
missionNamespace setVariable [Format["WFBE_%1STARTINGVEHICLES", _side], ['CUP_I_BMP2_AMB_NAPA']];//--- Starting Vehicles.
missionNamespace setVariable [Format["WFBE_%1PARAAMMO", _side], []];//--- Supply Paradropping, Dropped Ammunition.
missionNamespace setVariable [Format["WFBE_%1PARAVEHICARGO", _side], 'CUP_I_BRDM2_NAPA'];//--- Supply Paradropping, Dropped Vehicle.
missionNamespace setVariable [Format["WFBE_%1PARAVEHI", _side], 'rhsgref_ins_g_mi8amt'];//--- Supply Paradropping, Vehicle
