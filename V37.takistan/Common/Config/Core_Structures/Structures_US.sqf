...
missionNamespace setVariable [Format["WFBE_%1DEFENSES_MG", _side], ['CUP_B_M2StaticMG_US']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_GL", _side], ['CUP_B_MK19_TriPod_US']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_AAPOD", _side], ['CUP_B_CUP_Stinger_AA_pod_US']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_ATPOD", _side], ['CUP_B_TOW_TriPod_US']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_CANNON", _side], ['CUP_B_M119_US']];
