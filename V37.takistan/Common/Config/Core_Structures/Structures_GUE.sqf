...
missionNamespace setVariable [Format["WFBE_%1DEFENSES_MG", _side], ['CUP_I_DSHKM_TK_GUE']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_GL", _side], ['CUP_I_AGS_TK_GUE']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_AAPOD", _side], ['CUP_I_ZU23_TK_GUE']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_ATPOD", _side], ['CUP_I_SPG9_TK_GUE']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_CANNON", _side], ['CUP_I_D30_TK_GUE']];
