...
missionNamespace setVariable [Format["WFBE_%1DEFENSES_MG", _side], ['CUP_O_KORD_high_RU']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_GL", _side], ['CUP_O_AGS_RU']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_AAPOD", _side], ['CUP_O_Igla_AA_pod_RU','CUP_O_ZU23_RU']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_ATPOD", _side], ['CUP_O_Metis_RU','CUP_O_SPG9_ChDKZ']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_CANNON", _side], ['CUP_O_D30_RU','CUP_O_D30_RU']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_MASH", _side], ['land_cwr3_tent1_mash']];
missionNamespace setVariable [Format["WFBE_%1DEFENSES_MORTAR", _side], ['CUP_O_2b14_82mm_RU']];
