...
_constructed = ([_position,_direction,WFBE_SMALL_SITE_1_OBJECTS] Call WFBE_SE_FNC_CreateObjectsFromArray);
...
_constructed = _constructed + ([_position,_direction,WFBE_SMALL_SITE_2_OBJECTS] Call WFBE_SE_FNC_CreateObjectsFromArray);
