...
class WFBE_UpgradeMenu {
	...
	class controlsBackground {
		...
		class CA_Back_Button : CA_Quit_Button {
			x = 0.695;
			text = "<<";
			onButtonClick = "WFBE_WF_MenuAction = 1000;";
	...
	class controls {
		class CA_UpgradeList : RscListnBox {
			...
			onLBDblClick = "WFBE_WF_MenuAction = 1";
			onLBSelChanged = "WFBE_WF_MenuAction = 2";
		};/*
...
class WFBE_BuyGearMenu 
{
	...
	onLoad = "uiNamespace setVariable ['wfbe_dialog_ui_gear', _this select 0];['onLoad'] execVM 'Client\GUI\GUI_WFGear.sqf'";
	onUnload = "uiNamespace setVariable ['wfbe_dialog_ui_gear', nil]; ['onUnload'] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
	
	
	class controlsBackground {
		class WFBE_Background : RscTextGear {
			x = "SafeZoneX";
			y = "SafeZoneY";
			w = "SafeZoneW";
			h = "SafeZoneH";
		...
		class WFBE_Background_Header : WFBE_Background {
			x = "SafeZoneX";
			y = "SafeZoneY";
			w = "SafeZoneW";
			h = "SafeZoneH * 0.06";
		...
		class WFBE_Background_Footer : WFBE_Background {
			x = "SafeZoneX";
		...
		class WFBE_Menu_Title : RscTextGear {
		...
		class WFBE_Background_Gear : RscTextGear {
		...
		class WFBE_Menu_Icons_Frame : RscFrameGear {
		...
		class WFBE_Menu_Icons_Background : RscTextGear {
			x = "SafeZoneX + (SafeZoneW * 0.01)";
			y = "SafeZoneY + (SafezoneH * 0.07)";
			w = "SafeZoneW * 0.38";
			h = "SafeZoneH * 0.08";
		...
		class WFBE_Menu_ComboTarget_Frame : RscFrameGear {
			x = "SafeZoneX + (SafeZoneW * 0.01)";
			y = "SafeZoneY + (SafezoneH * 0.17)";
			w = "SafeZoneW * 0.38";
			h = "SafeZoneH * 0.055";
		};
		class WFBE_Menu_ComboTarget_Background : WFBE_Menu_Icons_Background {
			y = "SafeZoneY + (SafezoneH * 0.17)";
			h = "SafeZoneH * 0.055";
		};
		class WFBE_Menu_ComboTarget_Label : RscTextGear {
		...
		class WFBE_Menu_ShopList_Frame : RscFrameGear {
			x = "SafeZoneX + (SafeZoneW * 0.01)";
			y = "SafeZoneY + (SafezoneH * 0.245)";
			w = "SafeZoneW * 0.38";
			h = "SafeZoneH * 0.48";
		};
		class WFBE_Menu_LinkedList_Frame : RscFrameGear {
			x = "SafeZoneX + (SafeZoneW * 0.01)";
			y = "SafeZoneY + (SafezoneH * 0.745)";
			w = "SafeZoneW * 0.38";
			h = "SafeZoneH * 0.2";
		};
		class WFBE_Menu_ShopList_Background : WFBE_Menu_ComboTarget_Background {
			y = "SafeZoneY + (SafezoneH * 0.245)";
			h = "SafeZoneH * 0.48";
		};
		class WFBE_Menu_MagsList_Background : WFBE_Menu_ComboTarget_Background {
	...
	class controls {
		...
		class WFBE_Gear_Container_Uniform : RscTextGear {
			idc = 77001;
		...
		class WFBE_Gear_Container_Vest : WFBE_Gear_Container_Uniform {
			idc = 77002;
			
			x = "SafeZoneX + (SafeZoneW * 0.505)";
		};
		class WFBE_Gear_Container_Backpack : WFBE_Gear_Container_Uniform {
			idc = 77003;
			
			x = "SafeZoneX + (SafeZoneW * 0.60)";
		};
		class WFBE_Gear_Container_Helm : WFBE_Gear_Container_Uniform {
			idc = 77004;
		...
		class WFBE_Gear_Container_Glasses : WFBE_Gear_Container_Helm {
			idc = 77005;
			
			x = "SafeZoneX + (SafeZoneW * 0.774)";
		};
		class WFBE_Gear_Container_NVGoggles : WFBE_Gear_Container_Helm {
			idc = 77006;
			
			x = "SafeZoneX + (SafeZoneW * 0.847)";
		};
		class WFBE_Gear_Container_Binoculars : WFBE_Gear_Container_Helm {
			idc = 77007;
			
			x = "SafeZoneX + (SafeZoneW * 0.921)";
		};
		class WFBE_Gear_Container_Map : WFBE_Gear_Container_Uniform {
			idc = 77008;
		...
		class WFBE_Gear_Container_GPS : WFBE_Gear_Container_Map {
			idc = 77009;
			
			x = "SafeZoneX + (SafeZoneW * 0.759)";
		};
		class WFBE_Gear_Container_Radio : WFBE_Gear_Container_Map {
			idc = 77010;
			
			x = "SafeZoneX + (SafeZoneW * 0.818)";
		};
		class WFBE_Gear_Container_Compass : WFBE_Gear_Container_Map {
			idc = 77011;
			
			x = "SafeZoneX + (SafeZoneW * 0.877)";
		};
		class WFBE_Gear_Container_Clock : WFBE_Gear_Container_Map {
			idc = 77012;
			
			x = "SafeZoneX + (SafeZoneW * 0.936)";
		};
		
		class WFBE_Gear_Container_Primary : WFBE_Gear_Container_Uniform {
			idc = 77013;
		...
		class WFBE_Gear_Container_Primary_Muzzle : WFBE_Gear_Container_Map { // wasp
			idc = 77014;
		...
		class WFBE_Gear_Container_Primary_Flashlight : WFBE_Gear_Container_Primary_Muzzle {
			idc = 77015;
			
			x = "SafeZoneX + (SafeZoneW * 0.7565)";
		};
		class WFBE_Gear_Container_Primary_Optics : WFBE_Gear_Container_Primary_Muzzle {
			idc = 77016;
			
			x = "SafeZoneX + (SafeZoneW * 0.813)";
			w = "SafeZoneW * 0.064";
		};
                class WFBE_Gear_Container_Primary_Bipod : WFBE_Gear_Container_Primary_Muzzle {
			idc = 77017;
			
			x = "SafeZoneX + (SafeZoneW * 0.8795)";
		};
		class WFBE_Gear_Container_Primary_CurrentMagazine : WFBE_Gear_Container_Primary_Muzzle {
			idc = 77901;
			
			x = "SafeZoneX + (SafeZoneW * 0.936)";
		};
		
		class WFBE_Gear_Container_Secondary : WFBE_Gear_Container_Primary {
			idc = 77018;
			
			x = "SafeZoneX + (SafeZoneW * 0.70)";
			y = "SafeZoneY + (SafezoneH * 0.42)";
		};
		class WFBE_Gear_Container_Secondary_Muzzle : WFBE_Gear_Container_Map {
			idc = 77019;
		...
		class WFBE_Gear_Container_Secondary_Flashlight : WFBE_Gear_Container_Secondary_Muzzle {
			idc = 77020;
			
			x = "SafeZoneX + (SafeZoneW * 0.77375)";
		};
		class WFBE_Gear_Container_Secondary_Optics : WFBE_Gear_Container_Secondary_Muzzle {
			idc = 77021;
			
			x = "SafeZoneX + (SafeZoneW * 0.848)";
		};
        class WFBE_Gear_Container_Secondary_Bipod : WFBE_Gear_Container_Secondary_Muzzle {
			idc = 77022;
			
			x = "SafeZoneX + (SafeZoneW * 0.8515)+100";
		};
		class WFBE_Gear_Container_Secondary_CurrentMagazine : WFBE_Gear_Container_Secondary_Muzzle {
			idc = 77902;
			
			x = "SafeZoneX + (SafeZoneW * 0.92225)";
		};
		
		class WFBE_Gear_Container_Pistol : WFBE_Gear_Container_Primary {
			idc = 77023;
			x = "SafeZoneX + (SafeZoneW * 0.70)";
			y = "SafeZoneY + (SafezoneH * 0.595)";
		};
		class WFBE_Gear_Container_Pistol_Muzzle : WFBE_Gear_Container_Map {
			idc = 77024;
		...
		class WFBE_Gear_Container_Pistol_Flashlight : WFBE_Gear_Container_Pistol_Muzzle {
			idc = 77025;
			
			x = "SafeZoneX + (SafeZoneW * 0.77375)";
		};
		class WFBE_Gear_Container_Pistol_Optics : WFBE_Gear_Container_Pistol_Muzzle {
			idc = 77026;
			
			x = "SafeZoneX + (SafeZoneW * 0.848)";
		};
                class WFBE_Gear_Container_Pistol_Bipod : WFBE_Gear_Container_Pistol_Muzzle {
			idc = 77027;
			
			x = "SafeZoneX + (SafeZoneW * 0.8515)+100";
		};
		class WFBE_Gear_Container_Pistol_CurrentMagazine : WFBE_Gear_Container_Pistol_Muzzle {
			idc = 77903;
		...
		class WFBE_Gear_Container_Items_Unit : WFBE_Gear_Container_Pistol_Muzzle {
			idc = 77109;
		...
		//--- Actual controls
		class WFBE_Gear_Control_Items_Purchase : RscListNBoxGear {
			idc = 70108;
		...
		class WFBE_Gear_Control_Linked_Items : WFBE_Gear_Control_Items_Purchase {
			idc = 70601;
		...
		class WFBE_Gear_Control_Items_Unit : RscListNBoxGear {
			idc = 70109;
		...
		class WFBE_Gear_Control_Uniform: RscActiveTextGear {
			idc = 70001;
		...
		class WFBE_Gear_Control_Vest: WFBE_Gear_Control_Uniform {
			idc = 70002;
		...
		class WFBE_Gear_Control_Backpack: WFBE_Gear_Control_Uniform {
			idc = 70003;
		...
		class WFBE_Gear_Control_Helm: WFBE_Gear_Control_Uniform {
			idc = 70004;
		...
		class WFBE_Gear_Control_Glasses: WFBE_Gear_Control_Helm {
			idc = 70005;
		...
		class WFBE_Gear_Control_NVGoggles: WFBE_Gear_Control_Helm {
			idc = 70006;
		...
		class WFBE_Gear_Control_Binoculars: WFBE_Gear_Control_Helm {
			idc = 70007;
		...
		class WFBE_Gear_Control_Map: WFBE_Gear_Control_Uniform {
			idc = 70008;
		...
		class WFBE_Gear_Control_GPS: WFBE_Gear_Control_Map {
			idc = 70009;
		...
		class WFBE_Gear_Control_Radio: WFBE_Gear_Control_Map {
			idc = 70010;
		...
		class WFBE_Gear_Control_Compass: WFBE_Gear_Control_Map {
			idc = 70011;
		...
		class WFBE_Gear_Control_Clock: WFBE_Gear_Control_Map {
			idc = 70012;
		...
		class WFBE_Gear_Control_Primary: WFBE_Gear_Control_Uniform {
			idc = 70013;
		...
		class WFBE_Gear_Control_Primary_Muzzle: WFBE_Gear_Control_Map { // wasp
			idc = 70014;
		...
		class WFBE_Gear_Control_Primary_Side: WFBE_Gear_Control_Primary_Muzzle {
			idc = 70015;
		...
		class WFBE_Gear_Control_Primary_Optics: WFBE_Gear_Control_Primary_Muzzle {
			idc = 70016;
        ...
        class WFBE_Gear_Control_Primary_Bipod: WFBE_Gear_Control_Primary_Muzzle {
			idc = 70017;
		...
		class WFBE_Gear_Control_Primary_CurrentMagazine: WFBE_Gear_Control_Primary_Muzzle {
			idc = 70901;
		...
		class WFBE_Gear_Control_Secondary: WFBE_Gear_Control_Primary {
			idc = 70018;
		...
		class WFBE_Gear_Control_Secondary_Muzzle: WFBE_Gear_Control_Map {
			idc = 70019;
		...
		class WFBE_Gear_Control_Secondary_Side: WFBE_Gear_Control_Secondary_Muzzle {
			idc = 70020;
		...
		class WFBE_Gear_Control_Secondary_Optics: WFBE_Gear_Control_Secondary_Muzzle {
			idc = 70021;
        ...
        class WFBE_Gear_Control_Secondary_Bipod: WFBE_Gear_Control_Secondary_Muzzle {
			idc = 70022;
		...
		class WFBE_Gear_Control_Secondary_CurrentMagazine: WFBE_Gear_Control_Secondary_Muzzle {
			idc = 70902;
		...
		class WFBE_Gear_Control_Pistol: WFBE_Gear_Control_Primary {
			idc = 70023;
		...
		class WFBE_Gear_Control_Pistol_Muzzle: WFBE_Gear_Control_Map {
			idc = 70024;
		...
		class WFBE_Gear_Control_Pistol_Side: WFBE_Gear_Control_Pistol_Muzzle {
			idc = 70025;
		...
		class WFBE_Gear_Control_Pistol_Optics: WFBE_Gear_Control_Pistol_Muzzle {
			idc = 70026;
			...
			onLBDrop = "['onShoppingListLBDrop', 'Accessory', 77026, ((_this select 4) select 0) select 2, [0,2,1,2]] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
                ...
                class WFBE_Gear_Control_Pistol_Bipod: WFBE_Gear_Control_Pistol_Muzzle {
			idc = 70027;
		...
		class WFBE_Gear_Control_Pistol_CurrentMagazine: WFBE_Gear_Control_Pistol_Muzzle {
			idc = 70903;
		...
		class WFBE_Gear_Control_Combo_Target : RscComboGear {
			idc = 70201;
		...
		class WFBE_Gear_Uniform_Progress_Load : RscProgressGear {
			idc = 70301;
		...
		class WFBE_Gear_Vest_Progress_Load : WFBE_Gear_Uniform_Progress_Load {
			idc = 70302;
			
			x = "SafeZoneX + (SafeZoneW * 0.505)";
		};
		class WFBE_Gear_Backpack_Progress_Load : WFBE_Gear_Uniform_Progress_Load {
			idc = 70303;
			
			x = "SafeZoneX + (SafeZoneW * 0.60)";
		};
		
		class WFBE_Icon_Primary : RscActiveTextGear {
			idc = 70501;
			style = ST_KEEP_ASPECT_RATIO;
			x = "SafeZoneX + (SafeZoneW * 0.028)";
			y = "SafeZoneY + (SafezoneH * 0.07)";
			...
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_PRIMARY] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Secondary : WFBE_Icon_Primary {
			idc = 70502;
			x = "SafeZoneX + (SafeZoneW * 0.071)";
			
			text = "Rsc\Pictures\icon_wf_gear_secondary.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_SECONDARY] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Handgun : WFBE_Icon_Primary {
			idc = 70503;
			x = "SafeZoneX + (SafeZoneW * 0.114)";
			
			text = "Rsc\Pictures\icon_wf_gear_handgun.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_HANDGUN] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Accessories : WFBE_Icon_Primary {
			idc = 70504;
			x = "SafeZoneX + (SafeZoneW * 0.157)";
			
			text = "Rsc\Pictures\icon_wf_gear_accessories.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_ACCESSORIES] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Ammunitions : WFBE_Icon_Primary {
			idc = 70505;
			x = "SafeZoneX + (SafeZoneW * 0.2)";
			
			text = "Rsc\Pictures\icon_wf_gear_ammunition.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_AMMO] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Misc : WFBE_Icon_Primary {
			idc = 70506;
			x = "SafeZoneX + (SafeZoneW * 0.243)";
			
			text = "Rsc\Pictures\icon_wf_gear_miscellaneous.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_MISC] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Equipment : WFBE_Icon_Primary {
			idc = 70507;
			x = "SafeZoneX + (SafeZoneW * 0.286)";
			
			text = "Rsc\Pictures\icon_wf_gear_equipment.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_EQUIPMENT] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		class WFBE_Icon_Template : WFBE_Icon_Primary {
			idc = 70508;
			x = "SafeZoneX + (SafeZoneW * 0.329)";
			
			text = "Rsc\Pictures\icon_wf_building_barracks.paa";
			action = "['onShoppingTabClicked', WFBE_GEAR_TAB_TEMPLATES] call compile preprocessFileLineNumbers 'Client\GUI\GUI_WFGear.sqf'";
		};
		
		class WFBE_Gear_Control_CreateTemplate : RscButtonGear {
			idc = 70401;
		...
		class WFBE_Gear_Control_DeleteTemplate : WFBE_Gear_Control_CreateTemplate {
			idc = 70402;
		...
		class WFBE_Gear_Control_Buy : WFBE_Gear_Control_CreateTemplate {
			idc = 70403;
		...
		class WFBE_Menu_Control_Info : RscStructuredTextGear {
			idc = 70028;
			x = "SafeZoneX + (SafeZoneW * 0.41)";
		...
		class WFBE_Gear_Control_Clear : RscButton_LesserGear {
			idc = 70029;
			x = "SafeZoneX + (SafeZoneW * 0.01)";
			y = "SafeZoneY + (SafezoneH * 0.96)";
			w = "SafeZoneW * 0.185";
		...
		class WFBE_Gear_Control_Reload : WFBE_Gear_Control_Clear {
			idc = 70030;
		...
		class WFBE_Control_Exit : RscButtonGear {
			idc = 22555;
...
class RscMenu_Help {
	...
	onUnload = "uiNamespace setVariable ['WFBE_dialog_ui_onlinehelpmenu', nil]; ['onUnload'] call compile preprocessFileLineNumbers 'Client\GUI\GUI_Menu_Help.sqf'";
	class controlsBackground {
		...
		class WFBE_Menu_Title : RscText_Title {
			style = ST_LEFT;
		...
		class WFBE_Menu_InfoListFrame : RscFrame {
			x = "SafeZoneX + (SafeZoneW * 0.12)";
			y = "SafeZoneY + (SafezoneH * 0.175)";
			w = "SafeZoneW * 0.2";
			h = 0.676391 * safezoneH;
		};
		class WFBE_Menu_InfoResourcesFrame : RscFrame {
			x = "SafeZoneX + (SafeZoneW * 0.34)";
			y = "SafeZoneY + (SafezoneH * 0.175)";
			w = "SafeZoneW * 0.54";
			h = 0.676391 * safezoneH;
		};
		class WFBE_Menu_Info_Background : RscText {
			x = "SafeZoneX + (SafeZoneW * 0.34)";
			y = "SafeZoneY + (SafezoneH * 0.175)";
			w = "SafeZoneW * 0.54";
			h = 0.676391 * safezoneH;
	...
	class controls {
		class WFBE_Menu_Help_Topics : RscListBox {
			idc = 160001;
		...
		class Menu_Help_ControlsGroup : RscControlsGroup {
			...
			class controls {				
				class WFBE_Menu_Help_Explanation : RscStructuredText {
...
class WSW_roles_menu
{
    idd = 2800;
    name = "WSW_roles_menu";
    movingEnable = false;
    enableSimulation = true;
    onLoad = "[] spawn WSW_fnc_updateRolesMenu;";
    onUnload="[] spawn WSW_fnc_closeRoleSelectDialog;";
    class controlsBackground
    {
        class WSW_roles_menu_frame: RscFrame
        {
            idc = -1;
        ...
        class WSW_roles_menu_background: Box
        {
            idc = -1;
            x = 0.29375 * safezoneW + safezoneX;
            y = 0.225 * safezoneH + safezoneY;
        ...
        class WSW_roles_menu_header: RscText_Title
        {
            idc = -1;
            text = "ROLE SELECTOR";
            x = 0.29375 * safezoneW + safezoneX;
    ...
    class controls
    {
        class WSW_roles_menu_list: Skill_RscListbox
        {
            idc = 2801;
            ...
            h = 0.418 * safezoneH;
            sizeEx = 0.044;
            onLBSelChanged = "[] spawn WSW_fnc_selectRole;";
        };
        class WSW_roles_menu_details_role_name: Skill_RscStructuredText
        {
            idc = 2806;
        ...
        class WSW_roles_menu_details_slots: Skill_RscStructuredText
        {
            idc = 2822;
            x = 0.453594 * safezoneW + safezoneX;
        ...
        class WSW_roles_menu_details: Skill_RscStructuredText
        {
            idc = 2802;
            x = 0.453594 * safezoneW + safezoneX;
        ...
        class WSW_roles_menu_info: Skill_RscStructuredText
        {
            idc = 2803;
            text = "";
            x = 0.298906 * safezoneW + safezoneX;
        ...
        class WSW_roles_menu_learn: RscButton_Main
        {
            idc = 2804;
            text = "BUY ROLE";
            x = 0.298906 * safezoneW + safezoneX;
            ...
            w = 0.149531 * safezoneW;
            h = 0.044 * safezoneH;
            onButtonClick = "[] spawn WSW_fnc_buyRole;";
        };
        class WSW_roles_menu_reset: RscButton_Main
        {
            idc = 2805;
            text = "RESET ROLE";
            ...
            w = 0.0825 * safezoneW;
            h = 0.044 * safezoneH;
            onButtonClick = "[false] spawn WSW_fnc_resetRoles;";
        };
        class WSW_roles_menu_close: RscButton_Exit
        {
            idc = -1;
            text = "X";
            ...
            h = 0.03 * safezoneH;
            onButtonClick = "[] spawn WSW_fnc_closeRoleSelectDialog;";
        };
    };
};