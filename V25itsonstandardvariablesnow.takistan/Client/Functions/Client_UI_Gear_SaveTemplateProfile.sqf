...

{
	...
	if (_can_save) then {_profile_templates pushBack _x};
} forEach _templates;

//--- Finally save the gear.
profileNamespace setVariable [Format["CTI_PERSISTENT_%1_GEAR_TEMPLATE", CTI_Client_SideJoinedText], _profile_templates];
