...
_units = units _team;
_artyTypes = (missionNamespace getVariable Format ["CTI_%1_ARTILLERY_CLASSNAMES",_side]) select _index;
_artyWeapons = missionNamespace getVariable Format ["CTI_%1_ARTILLERY_WEAPONS",_side];
