...
//--- Generic.
missionNamespace setVariable [Format["CTI_%1CREW", _side], 'CUP_B_USMC_Soldier_FROG_DES'];
missionNamespace setVariable [Format["CTI_%1PILOT", _side], 'CUP_B_USMC_Soldier_FROG_DES'];
missionNamespace setVariable [Format["CTI_%1SOLDIER", _side], 'CUP_B_USMC_Soldier_FROG_DES'];

//--- Flag texture.
missionNamespace setVariable [Format["CTI_%1FLAG", _side], '\Ca\ca_e\Data\flag_us_co.paa'];

missionNamespace setVariable [Format["CTI_%1AMBULANCES", _side], ['LIB_OpelBlitz_Ambulance','LIB_US_Willys_MB_Ambulance','CUP_B_HMMWV_Ambulance_USA','CUP_B_M1133_MEV_Desert','uns_M577_amb','CUP_B_UH1Y_MEV_USMC','cwr3_b_uh60_mev']];
missionNamespace setVariable [Format["CTI_%1REPAIRTRUCKS", _side], ['CUP_B_MTVR_Repair_USA']];
missionNamespace setVariable [Format["CTI_%1SALVAGETRUCK", _side], ['cwr3_b_m939_open']];
...
//--- Paratroopers.
missionNamespace setVariable [Format["CTI_%1PARACHUTELEVEL1", _side],['CUP_B_USMC_Sniper_M40A3_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Soldier_AR_des','CUP_B_USMC_Engineer_des','CUP_B_USMC_Medic_des']];
missionNamespace setVariable [Format["CTI_%1PARACHUTELEVEL2", _side],['CUP_B_USMC_Sniper_M40A3_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Soldier_AR_des','CUP_B_USMC_Engineer_des','CUP_B_USMC_Medic_des','CUP_B_USMC_Soldier_AT_des','CUP_B_USMC_Soldier_AA_des','CUP_B_USMC_Spotter_des']];
missionNamespace setVariable [Format["CTI_%1PARACHUTELEVEL3", _side],['CUP_B_USMC_Sniper_M40A3_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Soldier_AR_des','CUP_B_USMC_Engineer_des','CUP_B_USMC_Medic_des','CUP_B_USMC_Soldier_AT_des','CUP_B_USMC_Soldier_AA_des','CUP_B_USMC_Spotter_des','CUP_B_BAF_Soldier_RiflemanAT_DDPM','CUP_B_USMC_Soldier_HAT_des','CUP_B_BAF_Sniper_AS50_TWS_DDPM']];

missionNamespace setVariable [Format["CTI_%1PARACARGO", _side], 'CUP_B_C130J_USMC'];//--- Paratroopers, Vehicle.
missionNamespace setVariable [Format["CTI_%1REPAIRTRUCK", _side], 'CUP_B_MTVR_Repair_USA'];//--- Repair Truck model.
missionNamespace setVariable [Format["CTI_%1STARTINGVEHICLES", _side], ['LIB_OpelBlitz_Ambulance','cwr3_b_m939_open']];//--- Starting Vehicles.
missionNamespace setVariable [Format["CTI_%1PARAAMMO", _side], ['rhsusf_mags_crate','rhsusf_gear_crate','rhsusf_launcher_crate']];//--- Supply Paradropping, Dropped Ammunition.
missionNamespace setVariable [Format["CTI_%1PARAVEHICARGO", _side], 'CUP_B_MTVR_Repair_USA'];//--- Supply Paradropping, Dropped Vehicle.
missionNamespace setVariable [Format["CTI_%1PARAVEHI", _side], 'CUP_B_UH60M_FFV_US'];//--- Supply Paradropping, Vehicle
...
if ((missionNamespace getVariable "CTI_C_BASE_PATROLS_INFANTRY") > 0) then {
	missionNamespace setVariable [Format["CTI_%1BASEPATROLS_0", _side],['CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_FROG_DES']];
	missionNamespace setVariable [Format["CTI_%1BASEPATROLS_1", _side],['CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Medic_des','CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_AR_des','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Engineer_des']];
	missionNamespace setVariable [Format["CTI_%1BASEPATROLS_2", _side],['CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Soldier_AR_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Sniper_M40A3_des']];
	missionNamespace setVariable [Format["CTI_%1BASEPATROLS_3", _side],['CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_AA_des','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Soldier_HAT_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_AT_des']];
	missionNamespace setVariable [Format["CTI_%1BASEPATROLS_4", _side],['CUP_B_USMC_Soldier_FROG_DES','CUP_B_USMC_Soldier_AA_des','CUP_B_USMC_Soldier_MG_des','CUP_B_USMC_Soldier_HAT_des','CUP_B_USMC_Soldier_LAT_des','CUP_B_USMC_Soldier_AT_des']];
};
//--- Server only.
...
// Sniper
missionNamespace setVariable ["CTI_WEST_DefaultGearSpot", [
	[
...
// Soldier
missionNamespace setVariable ["CTI_WEST_DefaultGearSoldier", [
	[
...
// Lock MAN
missionNamespace setVariable ["CTI_WEST_DefaultGearLock", [
	[
...
// UAVOperator
missionNamespace setVariable ["CTI_WEST_DefaultGearUAVOperator", [
	[
