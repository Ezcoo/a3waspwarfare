...
if (isServer) then {
    ...
    [_town,_townStartSV,_townRange] spawn {
        ...
        //--- Models creation.
        _townModel = createSimpleObject [missionNamespace getVariable "CTI_C_DEPOT", [0,0,0]];
        _townModel setDir ((getDir _town) + (missionNamespace getVariable "CTI_C_DEPOT_RDIR"));
        ...
        _camp_counter = 0;
        {
            ...
            _campModel = createSimpleObject [missionNamespace getVariable "CTI_C_CAMP", [0,0,0]];
            ...
            _flag = createSimpleObject [missionNamespace getVariable "CTI_C_CAMP_FLAG", [0,0,0]];
            _flag setPosATL (getPosATL _x);
            _flag setPosATL (_x modelToWorld (missionNamespace getVariable "CTI_C_CAMP_FLAG_POS"));
