...
//--- Deploy the model.
_chuteModel = missionNamespace getVariable Format ["CTI_%1PARACHUTE",CTI_Client_SideJoined];
...
waitUntil
{
	...
	if (_pz < 275 and _pz > 75) then {
		...
		_targets = _barrel nearEntities [["Car","Motorcycle","Tank","Ship","StaticCannon"], missionNamespace getVariable "CTI_C_ARTILLERY_AMMO_RANGE_SADARM"];
