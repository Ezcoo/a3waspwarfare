...
_camp_cap_rate = missionNamespace getVariable "CTI_C_CAMPS_CAPTURE_RATE";
_camp_range = missionNamespace getVariable "CTI_C_CAMPS_RANGE";
_camp_range_players = missionNamespace getVariable "CTI_C_CAMPS_RANGE_PLAYERS";
...
while {!CTI_GameOver} do {
	...
	for "_i" from 0 to ((count _camps) - 1) step 1 do
	{
		...
		_base = _camp getVariable "CTI_camp_bunker";
