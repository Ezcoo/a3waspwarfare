...
class RscTitles {
	...
	class OptionsAvailable {
		...
		controls[] = {"RUBHUD_Background","RUBHUD_Health","RUBHUD_Health_Value","RUBHUD_Uptime","RUBHUD_Uptime_Value","RUBHUD_Money","RUBHUD_Money_Value","RUBHUD_Income","RUBHUD_Income_Value","RUBHUD_Supply","RUBHUD_Supply_Value","RUBHUD_SupplyMin","RUBHUD_SupplyMin_Value","RUBHUD_City","RUBHUD_City_Value","RUBHUD_Server","RUBHUD_Server_Value",
		"statblue","score_blue","statred","score_red","RUBHUD_Commander","RUBHUD_Commander_Value","OptionsIcon0", "OptionsIcon1", "OptionsIcon2", "OptionsIcon3", "OptionsIcon4", "OptionsIcon5", "OptionsIcon6", "OptionsIcon7", "OptionsIcon8", "OptionsIcon9", "OptionsIcon10",
	...
	class EndOfGameStats {
		...
		class StatsBackGroundHeader : RscText {
			...
			w = 1;
			h = 0.18;
			colorBackground[] = CTI_EOGS_Background;
		};
		...
		class EastSoldiersRecruitedBar : RscText {
			...
			w = 0.4;
			h = 0.08;
			colorBackground[] = CTI_EOGS_SRVBBar;
		};
		...
		class EastSoldiersLostBar : EastSoldiersRecruitedBar {
			idc = 90104;
			y = 0.46;
			colorBackground[] = CTI_EOGS_SLVLBar;
		};
	...
	class CTI_ConstructionInterface {
		...
		class controls {
			class center : RscPictureKeepAspect {
				...
				h = 0.2;
				colorText[] = {1, 1, 1, 0.1};
				text = "Client\Images\cursor_w_laserlock_gs.paa";
			};
