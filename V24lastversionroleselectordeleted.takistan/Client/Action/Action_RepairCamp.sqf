...
if ((missionNamespace getVariable "cti_C_CAMPS_REPAIR_PRICE") > 0) then {
	...
	if ((Call cti_CL_FNC_GetPlayerFunds) < (missionNamespace getVariable "cti_C_CAMPS_REPAIR_PRICE")) exitWith {hint Format [localize "STR_WF_Repair_Camp_NoFunds", (missionNamespace getVariable "cti_C_CAMPS_REPAIR_PRICE") - (Call cti_CL_FNC_GetPlayerFunds)]};
