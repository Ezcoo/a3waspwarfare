...
_enabled = missionNamespace getVariable Format ["cti_C_UPGRADES_%1_ENABLED", _side];
_levels = missionNamespace getVariable Format ["cti_C_UPGRADES_%1_LEVELS", _side];
