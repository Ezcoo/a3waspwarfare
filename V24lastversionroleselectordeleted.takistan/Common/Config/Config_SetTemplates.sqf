...
if (isNil {missionNamespace getVariable Format ["cti_%1_Template", _side]}) then {
	missionNamespace setVariable [Format ["cti_%1_Template", _side], _s];
} else {
	missionNamespace setVariable [Format ["cti_%1_Template", _side], (missionNamespace getVariable Format ["cti_%1_Template", _side]) + _s];
};