...
_n			= ["CUP_I_DSHkM_MiniTriPod_TK_GUE"];
_n pushBack "CUP_I_DSHKM_TK_GUE";
_n pushBack "CUP_I_SPG9_TK_GUE";
_n pushBack "CUP_I_ZU23_TK_GUE";
...
missionNamespace setVariable [Format["cti_%1DEFENSES_MG", _side], ['CUP_I_DSHKM_TK_GUE']];
missionNamespace setVariable [Format["cti_%1DEFENSES_GL", _side], ['CUP_I_AGS_TK_GUE']];
missionNamespace setVariable [Format["cti_%1DEFENSES_AAPOD", _side], ['CUP_I_ZU23_TK_GUE']];
missionNamespace setVariable [Format["cti_%1DEFENSES_ATPOD", _side], ['CUP_I_SPG9_TK_GUE']];
missionNamespace setVariable [Format["cti_%1DEFENSES_CANNON", _side], ['CUP_I_D30_TK_GUE']];
missionNamespace setVariable [Format["cti_%1DEFENSES_MASH", _side], ['land_cwr3_tent1_mash']];
missionNamespace setVariable [Format["cti_%1DEFENSES_MORTAR", _side], ['CUP_I_2b14_82mm_TK_GUE']];
